...
Процедура ДобавитьВОчередьОтправкиДокументовОтгрузки(СсылкаНаДокумент) Экспорт
	...
	лКлючАлгоритма = "РегистрСведений_ОчередьОтправкиДокументовОтгрузки_МодульМенеджера_ДобавитьВОчередьОтправкиДокументовОтгрузки";
...
Процедура Добавить(Контрагент, Документ, Период = Неопределено, ДатаОтправки = Неопределено, ДатаОтменыОтправки = Неопределено, Комментарий = "", Ошибка = Ложь, АдресЭлПочтыССайта = "") Экспорт
	
	лКлючАлгоритма = "РегистрСведений_ОчередьОтправкиДокументовОтгрузки_МодульМенеджера_Добавить";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
	...
	МЗ.АдресЭлПочтыССайта	= АдресЭлПочтыССайта;
...
Процедура ДобавитьКОтправке(Контрагент, Документ, Период = Неопределено, Комментарий = "", АдресЭлПочтыССайта = "") Экспорт
	
	лКлючАлгоритма = "РегистрСведений_ОчередьОтправкиДокументовОтгрузки_МодульМенеджера_ДобавитьКОтправке";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
	...
	Добавить(Контрагент, Документ, Период,,, Комментарий,, АдресЭлПочтыССайта);
...
Процедура Удалить(Документ, Контрагент = Неопределено) Экспорт
	...
	лКлючАлгоритма = "РегистрСведений_ОчередьОтправкиДокументовОтгрузки_МодульМенеджера_Удалить";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура УстановитьДатуОтправки(Документ, Контрагент = Неопределено, ДатаОтправки = Неопределено, Комментарий = "") Экспорт
	...
	лКлючАлгоритма = "РегистрСведений_ОчередьОтправкиДокументовОтгрузки_МодульМенеджера_УстановитьДатуОтправки";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура УстановитьДатуОтменыОтправки(Документ, Контрагент = Неопределено, ДатаОтменыОтправки = Неопределено, Комментарий = "") Экспорт
	...
	лКлючАлгоритма = "РегистрСведений_ОчередьОтправкиДокументовОтгрузки_МодульМенеджера_УстановитьДатуОтменыОтправки";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура УстановитьОшибкуОтправки(Документ, Контрагент =Неопределено, Комментарий = "") Экспорт
	...
	лКлючАлгоритма = "РегистрСведений_ОчередьОтправкиДокументовОтгрузки_МодульМенеджера_УстановитьОшибкуОтправки";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Функция СостояниеДокумента(Документ, Контрагент = Неопределено, СостояниеСтрокой = Ложь) Экспорт
	...
	лКлючАлгоритма = "РегистрСведений_ОчередьОтправкиДокументовОтгрузки_МодульМенеджера_СостояниеДокумента";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
