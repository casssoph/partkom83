Процедура ДобавитьЗапись(СсылкаНаДокумент, ДатаДокумента = Неопределено ) Экспорт
	
	лКлючАлгоритма = "РегистрСведений_ГраницаМФП_МодульМенеджера_ДобавитьЗапись";
	...
	Если Результат.Пустой() Тогда
		...
		МЗ = РегистрыСведений.ГраницаМФП.СоздатьМенеджерЗаписи();
...
Процедура УдалитьЗапись(ДатаСоздания) Экспорт
	
	лКлючАлгоритма = "РегистрСведений_ГраницаМФП_МодульМенеджера_УдалитьЗапись";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
	...
	НЗ.Отбор.ДатаСоздания.Установить(ДатаСоздания);
	НЗ.Записать();
