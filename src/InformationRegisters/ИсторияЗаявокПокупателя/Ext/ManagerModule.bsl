Процедура ДобавитьДанныеИсторияЗаявокПокупателя(Список, НомерСообщения, СтруктураХранения) Экспорт
	...
	ОтметитьОтправленныеСтрокиВSQL(НомерСообщения, ТаблицаОтбора, СтруктураХранения);
...
КонецФункции
Процедура ОтметитьОтправленныеСтрокиВSQL(НомерСообщения, СтрокаОтбора, СтруктураХранения)
	
	ТекстЗапросаSQL = ТекстЗапросаОтметкиОтправленного(НомерСообщения, СтрокаОтбора, СтруктураХранения);
