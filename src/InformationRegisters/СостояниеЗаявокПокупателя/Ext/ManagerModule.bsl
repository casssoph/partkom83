...
Процедура ДобавитьДанныеСостояниеСтрокЗаявок(Список, НомерСообщения, СтруктураХранения) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ЗаполнитьЗначенияСвойств(ОбъектXDTO, Выборка, "IDSite,Дата,Артикул,КоличествоВЗаявке,КоличествоГотовоКВыдаче,КоличествоЗаказано,КоличествоОтказано,КоличествоНаСкладе,КоличествоВыдано,КоличествоВРезерве,КоличествоПоступило,Цена,ЗакупочнаяЦена,Розница");
