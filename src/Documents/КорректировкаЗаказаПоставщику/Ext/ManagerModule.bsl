...
Функция РегистрыНакопления_ЗаявкиПокупателей(вхСсылкаНаДокумент, вхОтказ, вхПараметры = Неопределено)
...
Запрос = новый запрос("ВЫБРАТЬ
                      ...
                      |	ВТОтказы.Количество,
                      |	ЗаявкиПокупателейОстатки.СуммаРеглОстаток / ЗаявкиПокупателейОстатки.КоличествоОстаток * ВТОтказы.Количество КАК СуммаРегл,
                      |	ЗаявкиПокупателейОстатки.СуммаУпрОстаток / ЗаявкиПокупателейОстатки.КоличествоОстаток * ВТОтказы.Количество КАК СуммаУпр,
                      |	ИСТИНА КАК Отказ,
                      |	&Период,
...
Функция РегистрыНакопления_ЗаказыПоставщикам(вхСсылкаНаДокумент, вхОтказ, вхПараметры = Неопределено)
	...
	Иначе
		...
		|	втТовары.СуммаУпр / втТовары.Количество * ВТОтказы.КоличествоДокумент - ВТОтказы.КоличествоРегистр,
		|	втТовары.СуммаРегл / втТовары.Количество * ВТОтказы.КоличествоДокумент - ВТОтказы.КоличествоРегистр,
		|	&Ссылка,
