...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если мНеПерезаполнятьДвижения Тогда
		// ЛНА, Замер  APDEX ++(
		APDEX_ОценкаПроизводительностиКлиентСервер.ЗакончитьЗамерВремени("ЗаявкаПокупателя_Проведение");
		//)--
	...
	// ЛНА, Замер  APDEX ++(
	Попытка		
		APDEX_ОценкаПроизводительностиКлиентСервер.ЗакончитьЗамерВремени("ЗаявкаПокупателя_Проведение", СокрЛП(Ссылка));
	Исключение
	КонецПопытки;
	//)--
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Попытка
		Если ЗначениеЗаполнено(ИсточникЗаявки) Тогда 
			Если Не ИсточникЗаявки=Перечисления.ИсточникиЗаявок.РучнойВвод И (Ответственный=Справочники.Пользователи.НайтиПоНаименованию("Администратор") Или Ответственный=Справочники.Пользователи.НайтиПоНаименованию("_DataExchanger") Или Ответственный=Справочники.Пользователи.НайтиПоНаименованию("Robot")) Тогда 
