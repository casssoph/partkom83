...
Функция ВозможноПодтверждениеЗаявки(ФрмТовары, ТекстОшибки) Экспорт
...
Функция ПолучитьПараметрыПечатиСчетаЗаказа() Экспорт
	...
	Если ЗначениеЗаполнено(БанковскийСчет) Тогда
		Банк       = ?(Не ЗначениеЗаполнено(БанковскийСчет.БанкДляРасчетов), БанковскийСчет.Банк, БанковскийСчет.БанкДляРасчетов);
