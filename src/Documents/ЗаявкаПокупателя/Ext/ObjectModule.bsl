...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если НЕ ДополнительныеСвойства.Свойство("НеМенятьОтветственного") ИЛИ НЕ ЗначениеЗаполнено(Ответственный) Тогда 
...
Процедура ПроверитьСоздатьКорректировку(РежимЗаписи, РежимПроведения, Отказ) Экспорт
	...
	Если Не ЭтоНовый() И РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		Если ЕстьИзменения Тогда
			...
			//Семенов 10.12.2018( условие на доп. свойство для загрузки
			Если ДополнительныеСвойства.Свойство("НеМенятьОтветственного") Тогда
