...
Процедура ПриОткрытии(Отказ)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ПриОткрытии";
...
Процедура СтруктураПодчиненности(Команда)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_СтруктураПодчиненности";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ДвиженияДокумента(Команда)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ДвиженияДокумента";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ИсторияДокумента(Команда)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ИсторияДокумента";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ПоискПоНомеру(Команда)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ПоискПоНомеру";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ОтключитьОтборыСписка()
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ОтключитьОтборыСписка";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ПриСозданииНаСервере";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ПоискПоSiteID(Команда)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ПоискПоSiteID";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ИсторияСтрокЗаявок(Команда)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ИсторияСтрокЗаявок";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ВыгрузитьИсториюСтрокЗаявок(Команда)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ВыгрузитьИсториюСтрокЗаявок";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ВыгрузитьИсториюСтрокЗаявокСервер(Заявка)
	лКлючАлгоритма = "Документ_ЗявкаПокупателя_ФормаСпискаУправляемая_ВыгрузитьИсториюСтрокЗаявокСервер";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
