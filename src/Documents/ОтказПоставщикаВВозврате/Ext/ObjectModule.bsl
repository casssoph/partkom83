...
Процедура ОбработкаЗаполнения(Основание)
	...
	Если ТипЗнч(Основание) = Тип("ДокументСсылка.ВозвратТоваровПоставщику") Тогда
		...
		СтатусДокумента 	= Справочники.СтатусыДокументов.ОтказПоставщикаВВозвратеНовый;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ЭтоНовый() Тогда
		...
		Если СсылкаНаДокумент.Пустая() Тогда 
			СсылкаНаДокумент = Документы.ОтказПоставщикаВВозврате.ПолучитьСсылку();
...
Процедура ПересчитатьСуммуТабличнойЧасти() Экспорт
	...
	лКлючАлгоритма = "Документ_ОтказПоставщикаВВозвратея_МодульОбъекта_ПересчитатьСуммуТабличнойЧасти";
...
Процедура ПересчитатьСуммуСтрокиТабличнойЧасти(СтрокаТабличнойЧасти, ОбъектДокумента) Экспорт
	...
	лКлючАлгоритма = "Документ_ОтказПоставщикаВВозврате_МодульОбъекта_ПересчитатьСуммуСтрокиТабличнойЧасти";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Функция ВсеПринятоеКоличествоРазмещено() Экспорт
	...
	лКлючАлгоритма = "Документ_ОтказПоставщикаВВозврате_МодульОбъекта_ВсеПринятоеКоличествоРазмещено";
	лЗамена = АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
...
Процедура ЗаполнитьРазмещенноеКоличество(ТекстОшибки = "", СообщатьОбОшибке = Истина) Экспорт
	...
	лКлючАлгоритма = "Документ_ОтказПоставщикаВВозврате_МодульОбъекта_ЗаполнитьРазмещенноеКоличество";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
	...
	ИмяПоляКоличества = ?(СтатусДокумента = Справочники.СтатусыДокументов.ОтказПоставщикаВВозвратеНовый, "КоличествоПлан", "Количество");
	Для каждого СтрокаТЧ Из Товары Цикл
...
Функция ВыгрузитьВОбменТоплог() Экспорт
	...
	лКлючАлгоритма = "Документ_ОтказПоставщикаВВозврате_МодульОбъекта_ВыгрузитьВОбменТоплог";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	лКлючАлгоритма = "Документ_ОтказПоставщикаВВозврате_МодульОбъекта_ОбработкаПроверкиЗаполнения";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда		
		Выполнить(лЗамена);
		Возврат;		
...
Процедура ОтразитьСобытиеКОбработкеАктовРассмотренияВозврата()
	...
	лКлючАлгоритма = "Документ_ОтказПоставщикаВВозврате_МодульОбъекта_ОтразитьСобытиеКОбработкеАктовРассмотренияВозврата";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
	...
	Если лРеквизиты.СтатусДокумента = Справочники.СтатусыДокументов.ОтказПоставщикаВВозвратеНовый Тогда 
		 Возврат;
	КонецЕсли;
