...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПеремещениеТоваров") Тогда
		РеквизитыОснования = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументОснование, "СкладОтправитель, СкладПолучатель, СкладОтправитель.Возвраты, СкладОтправитель.СкладВозвратов, СкладПолучатель.СкладВозвратов");
		
		Если РеквизитыОснования.СкладОтправительВозвраты 
			И НЕ РеквизитыОснования.СкладПолучательСкладВозвратов = РеквизитыОснования.СкладОтправитель Тогда  //это не перемещение в рабочую зону
