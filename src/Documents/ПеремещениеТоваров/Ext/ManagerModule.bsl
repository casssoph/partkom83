...
Функция ОстаткиСтрокПрихода(ДокументОснование, ДокСсылка)
	...
	ОбщегоНазначения.РаспределитьТаблицу1ПоТаблице2(Размещено, ОстаткиСтрокПрихода, ВыходнаяТаблица);
...
Функция ОстаткиСтрокПриходаДляПеремещения(ДокументОснование, ДокСсылка)
	...
	ОбщегоНазначения.РаспределитьТаблицу1ПоТаблице2(РазмещеноСтрокамЗаявок, ОстаткиСтрокПриходаПоСтрокамЗаявок, ВыходнаяТаблица2);
