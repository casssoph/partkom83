		...
		Если ОбъектXDTO.Тип().Имя = "РезультатРазмещения" Тогда  
			Попытка
				...
				Для Каждого ЗаказНаПриемкуXDTO Из Заказы Цикл 
					Попытка
						ЗагрузитьРезультатРазмещения(РазмещениеСсылкаТопЛог, ЗаказНаПриемкуXDTO, ОбъектXDTO, ТаблицаСсылок);
					Исключение
						Успешно = Ложь;
...
Процедура ЗагрузитьРезультатРазмещения(РазмещениеСсылкаТопЛог, ЗаказНаПриемкуXDTO, ОбъектXDTO, ТаблицаСсылок)
	...
	Если ЭтоПоступление Тогда 	
		ЗагрузитьРезультатРазмещенияФрагмент1(ДокументОснование, ЗаказНаПриемкуXDTO, ОбъектXDTO, РазмещениеСсылкаТопЛог, ТаблицаСсылок);
	Иначе
		ЗагрузитьРезультатРазмещенияФрагмент2(ДокументОснование, ЗаказНаПриемкуXDTO, ОбъектXDTO, РазмещениеСсылкаТопЛог, ТаблицаСсылок);
	КонецЕсли;
...
Функция ОбработатьРазмещение(Знач ДокСсылка, Знач ДокументОснование, Знач ОбъектXDTO, Знач РазмещениеСсылкаТопЛог, Знач ТаблицаРаспределить, Знач ТаблицаУбрать, Знач ТребуетсяОчисткаТЧ, Успешно, Знач РазмещениеЯчейкаСкладСсылка)
	...
	Попытка
		...
		ОстаткиПоРегистру = ОстаткиСтрокПрихода(ДокументОснование, ТаблицаРаспределить);
...
Функция ОбработатьРазмещениеДляПеремещения(Знач ДокСсылка, Знач ДокументОснование, Знач ОбъектXDTO, Знач РазмещениеСсылкаТопЛог, Знач Дельта, Знач Дельта2, Знач ТребуетсяОчисткаТЧ, Успешно, Знач РазмещениеЯчейкаСкладСсылка)
	...
	Попытка
		...
		СтруктураТаблиц = ОстаткиСтрокПриходаДляПеремещения(ДокументОснование);
...
Функция ОстаткиСтрокПрихода(ДокументОснование, ТаблицаРаспределить)
...
Функция ОстаткиСтрокПриходаДляПеремещения(ДокументОснование)
