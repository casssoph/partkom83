...
Функция ОстаткиСтрокПрихода(ДокументОснование, ДокСсылка)
	...
	ОбщегоНазначения.РаспределитьТаблицу1ПоТаблице2(Отбор, Размещено, ОстаткиСтрокПрихода, ВыходнаяТаблица);
...
Функция ОстаткиСтрокПриходаДляПеремещения(ДокументОснование, ДокСсылка)
	...
	ОбщегоНазначения.РаспределитьТаблицу1ПоТаблице2(Отбор,РазмещеноСтрокамЗаявок, ОстаткиСтрокПриходаПоСтрокамЗаявок, ВыходнаяТаблица2);
