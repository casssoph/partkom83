...
Процедура КонтрольОстатков(вхСсылкаНаДокумент, вхОтказ, вхПараметры) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |		ПО (ТоварыНаСкладахОстатки.Номенклатура = ТоварыНаСкладахОстатки.Номенклатура)
	               |			И (ТоварыНаСкладахОстатки.Склад = ТоварыНаСкладахОстатки.Склад)
	               |			И (ТоварыНаСкладахОстатки.Качество = ТоварыНаСкладахОстатки.Качество)
