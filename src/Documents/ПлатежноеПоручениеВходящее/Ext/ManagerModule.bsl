...
Функция РегистрыНакопления_ДенежныеСредства(вхСсылкаНаДокумент, вхОтказ, вхПараметры)
	...
	|	ПлатежноеПоручениеВходящееРасшифровкаПлатежа.СуммаВзаиморасчетов * ПлатежноеПоручениеВходящееРасшифровкаПлатежа.КурсВзаиморасчетов / ПлатежноеПоручениеВходящееРасшифровкаПлатежа.КратностьВзаиморасчетов КАК СуммаУпр
	|ИЗ
