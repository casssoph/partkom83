...
Функция ПолучитьЗаписиПоследовательности(вхПоследовательность) Экспорт
	лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_ПолучитьЗаписиПоследовательности";
...
Процедура Печать(ИмяМакета, КоличествоЭкземпляров = 1, НаПринтер = Ложь) Экспорт
	 лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_Печать";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_ПолучитьСтруктуруПечатныхФорм";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Функция СтруктураОбязательныхПолейОплатаУпр()
	лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_СтруктураОбязательныхПолейОплатаУпр";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Функция СтруктураОбязательныхПолейРасчетыУпр()
	лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_СтруктураОбязательныхПолейРасчетыУпр";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Процедура ПроверитьЗначение(Значение, Отказ, Заголовок, ИмяРеквизита)
	 лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_ПроверитьЗначение";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ОбработкаЗаполнения(Основание)
	 лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_ОбработкаЗаполнения";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	 лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_ОбработкаПроведения";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ОбработкаУдаленияПроведения(Отказ)
	 лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_ОбработкаУдаленияПроведения";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	 лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_ПередЗаписью";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ПриУстановкеНовогоНомера(СтандартнаяОбработка, Префикс)
	 лКлючАлгоритма = "Документ_ПлатежноеПоручениеВходящее_МодульОбъекта_ПриУстановкеНовогоНомера";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
