...
Процедура ПриОткрытии(Отказ)
	...
	лКлючАлгоритма = "Документ_КорректировкаЗаявкиПокупателя_ФормаСпискаОграниченная_ПриОткрытии";
	...
	Если ИспользоватьРасширенныеФормыСписков = Истина Тогда
		ОткрытьФорму("Документ.КорректировкаЗаявкиПокупателя.Форма.ФормаСписка");
		ЭтаФорма.Закрыть();
	КонецЕсли;	
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	лКлючАлгоритма = "Документ_КорректировкаЗаявкиПокупателя_ФормаСпискаОграниченная_ПриСозданииНаСервере";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
