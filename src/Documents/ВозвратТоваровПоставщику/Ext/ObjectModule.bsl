...
Процедура ОбработатьСчФ(пар_Событие = 1)
	...
	ИначеЕсли пар_Событие = 1 тогда
		...
		Контрагент_флРаботает_сКоррСФ = ?(ЗначениеЗаполнено(Контрагент),ОбщегоНазначения.ПолучитьЗначениеРеквизита(Контрагент,"флРаботает_сКоррСФ"),Истина);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не Контрагент.флРаботает_сКоррСФ	 тогда 
