...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ВидОперации = Перечисления.ВидыОперацийВозвратПоставщику.КорректировочныйСчетФактура Тогда 
		ПроверяемыеРеквизиты.Добавить("КоррСФНомер");
		ПроверяемыеРеквизиты.Добавить("КоррСФДата");
	ИначеЕсли ВидОперации = Перечисления.ВидыОперацийВозвратПоставщику.ОбратнаяРеализация Тогда 
