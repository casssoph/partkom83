...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.АктРассмотренияВозврата") Тогда
		...
		РеквизитыОснования = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДанныеЗаполнения, "КодВозврата");
		...
		КонецЦикла;
		//ХудинВВ 12042019 отключено, для экспертизы будет отдельный документ
		//Если РеквизитыОснования.КодВозврата = Справочники.КодыВозврата.НаЭкспертизу Тогда
		//	СтатусДокумента 		= Справочники.СтатусыДокументов.ВозвратТоваровПоставщикуНовыйНаЭкспертизу;
		//Иначе
			СтатусДокумента 		= Справочники.СтатусыДокументов.ВозвратТоваровПоставщикуНовый;
		//КонецЕсли;
