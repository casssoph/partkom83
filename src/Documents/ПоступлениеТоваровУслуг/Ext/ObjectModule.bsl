...
Процедура РасчетДатыОплаты(РежимЗаписи)
	...
	Если РежимЗаписи = РежимЗаписиДокумента.Проведение И Не НеИзменятьДатуОплаты Тогда
		...
		Иначе
			...
			Если РеквизитыДоговора.ДоговорНаОферту И Не РеквизитыДоговора.ВидУсловийДоговора = Перечисления.ВидыУсловийДоговоровВзаиморасчетов.СДополнительнымиУсловиями 
				Или РеквизитыДоговора.ВидРасчетаДней = Перечисления.ВидыРасчетаДней.ПоБанковскимДням Тогда 
