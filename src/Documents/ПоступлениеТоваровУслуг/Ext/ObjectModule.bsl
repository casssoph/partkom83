...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ((Не (ВидОперацииПоступления = Перечисления.ВидыПоступленияТоваров.ЗачетТовараVMI Или ВидОперацииПоступления = Перечисления.ВидыПоступленияТоваров.Прочее) 
		...
		Иначе		
			...
			Если ЗаказыПоставщикамСервер.ЭтоСкладНовойСхемы(Склад) тогда 
				...
				ЗаказыПоставщикамКлиентСервер.РазместитьДокументПоступленияПоЗаказам(ЭтотОбъект,СтруктуктураПараметров);
				КонецЕсли;
		    Иначе 
	...
	Если ВидОперацииПоступления <> Перечисления.ВидыПоступленияТоваров.МФП Тогда
