...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если СтатусДокумента = Справочники.СтатусыДокументов.ПоступлениеТоваровОтгружен И РазмещениеСтрокПрихода.Количество() = 0 
		И (ВидОперацииПоступления = Перечисления.ВидыПоступленияТоваров.Импорт ИЛИ ПараметрыСклада.Бонусный ИЛИ ПараметрыСклада.Сувенирный) Тогда
