...
Функция РегистрыНакопления_Взаиморасчеты(вхСсылкаНаДокумент, вхОтказ, вхПараметры = Неопределено)
	...
	//Если вхПараметры.СозданВ77 Тогда
		СтруктураРеквизитов = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(вхСсылкаНаДокумент, 
		"ВидОперацииПоступления,ДоговорКонтрагента,ВалютаДокумента,КурсВзаиморасчетов,КратностьВзаиморасчетов,СуммаДокумента,КонтрагентВзаиморасчетов,ДоговорКонтрагентаВзаиморасчетов");
...
Функция ОчиститьНомерГТД(Номер)
	НовыйНомер = "";
