...
Функция РегистрыНакопления_ЗаказыПоставщикам(вхСсылкаНаДокумент, вхОтказ, вхПараметры = Неопределено)  Экспорт
	...
	ЗапросЗаявок = новый Запрос("ВЫБРАТЬ РАЗЛИЧНЫЕ
	                            ...
	                            |	МАКСИМУМ(ЗаказыПоставщикам.ТорговаяТочка) КАК ТорговаяТочка,
	                            |	МАКСИМУМ(ЗаказыПоставщикам.ДоговорКонтрагента) КАК ДоговорКонтрагента,
	                            |	СУММА(ЗаказыПоставщикам.Количество) КАК Количество,
	                            |	СУММА(ЗаказыПоставщикам.СуммаРегл) КАК СуммаРегл,
