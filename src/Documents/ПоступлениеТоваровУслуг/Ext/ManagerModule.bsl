...
Процедура ЗарегистрироватьОшибкуЗагрузкиДокумента(СтруктураШапкиДокумента,ОшибкиЗагрузки)
	...
	КритическиеСобытияСервер.ЗарегистрироватьКритическоеСобытие(СтруктураШапкиДокумента.СсылкаНаДокумент,Справочники.СобытияДляОтправкиЭлектронныхПисем.ОшибкаЗагрузкиИзОП,СообщениеОбОшибке);	
