...
Процедура ПроверитьКорректностьТаблицыТоваров(ТаблицаТоваров,ОшибкиРазмещения)
	...
	Для каждого СтрокаНеНайденаяНоменклатура из НеНайденаяНоменклатура цикл
		ОбщегоНазначенияКлиентСервер.ДобавитьОшибкуПользователю(ОшибкиРазмещения,,"Не удалось найти номенклатуру по артикулу: " +  СтрокаНеНайденаяНоменклатура.Артикул + " (наименоваие: "+СтрокаНеНайденаяНоменклатура.Наименование+")");
	КонецЦикла;
Конецпроцедуры	
