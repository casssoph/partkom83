...
Функция СтруктураШапкиДокумента(ОбъектXDTO, ТаблицаОшибок, Отказ)
	...
	Структура.Вставить("СсылкаНаДокумент", СсылкаНаДокумент(Структура.НомерВходящегоДокумента, Структура.ДатаВходящегоДокумента, Структура.Организация, Структура.Контрагент, ТаблицаОшибок, Отказ));
...
КонецФункции
Функция СсылкаНаДокумент(НомерВходящегоДокумента, ДатаВходящегоДокумента, Организация, Контрагент, ТаблицаОшибок, Отказ)
