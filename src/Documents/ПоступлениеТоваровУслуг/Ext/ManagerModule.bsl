...
Функция ВыгрузитьЭлементы(вхТаблицаСсылокНаОбъекты, вхПланОбмена) Экспорт
	...
	ИначеЕсли лМетаданныеПланаОбмена = Метаданные.ПланыОбмена.ОбменПартКом83_TopLog Тогда 
		...
		//Валиахметов http://jira.part-kom.ru/browse/XX-2168 Выгружать из 1С8 в ВМС с док-том ПТУ параметр "Срочная поставка"
		...
		//Конец Валиахметов http://jira.part-kom.ru/browse/XX-2168 
		...
		|		ИНАЧЕ ПоступлениеТоваровУслугТовары.Цена
		|	КОНЕЦ КАК Цена,
		//Конец Валиахметов http://jira.part-kom.ru/browse/XX-2255 18.04.2019 
