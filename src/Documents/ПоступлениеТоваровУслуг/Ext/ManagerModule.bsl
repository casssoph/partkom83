...
Функция ПолучитьСтруктуруПараметровРазмещения(ШапкаДокумента) 
	...
	СтруктураПараметров.вставить("ЗаказРавенПриходу",ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ШапкаДокумента.Контрагент,"ЗаказРавенПриходу"));
	СтруктураПараметров.вставить("ЗаказРаспределения",ШапкаДокумента.ЗаказДляОтбора);	
	СтруктураПараметров.вставить("ЗаписатьДокумент",Ложь);
