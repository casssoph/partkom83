...
Процедура ВыгрузитьДокументВОП(ДокументСсылка,МассивОбъектовXDTO)
	...
	СтруктураЗаписи.Вставить("doc_date",Формат(РеквизитыДокумента.ДатаДокумента, "ДФ=yyyy-MM-dd"));
	СтруктураЗаписи.Вставить("doc_time",Формат(РеквизитыДокумента.ДатаДокумента, "ДФ=hh:mm"));
	...
	Иначе 
		...
		СообщенияОшибок = СтрокаОшибки.ДополнительныеСведения;	
		СтруктураЗаписи.Вставить("items",СообщенияОшибок);
...
Процедура ДобавитьСтрокуВМассивОбъектовXDTO(МассивОбъектовXDTO,ТипОбъектаXDTO,СтруктураЗаписи,Ошибка = ложь)
	...
	Если Ошибка тогда 
		...
		СписокОбъектов = ТипОшибкиСтроки.ПолучитьСписок("item");
