...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.АктРассмотренияВозврата") Тогда
		...
		|	АктРассмотренияВозвратаТовары.Количество КАК КоличествоПлан,
...
Процедура ОтразитьСобытиеКОбработкеАктовРассмотренияВозврата()
	...
	лРеквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Ссылка, "СтатусДокумента, КодВозврата, АктРассмотренияВозврата, АктРассмотренияВозврата.СтатусДокумента, АктРассмотренияВозврата.КодВозврата, АктРассмотренияВозврата.КодВозвратаОбновленИзТоплог");
	
	Если Не ЗначениеЗаполнено(лРеквизиты.АктРассмотренияВозврата) Тогда
		Возврат;
	КонецЕсли;
	
	Если НЕ лРеквизиты.АктРассмотренияВозвратаКодВозвратаОбновленИзТоплог 
		И ЗначениеЗаполнено(лРеквизиты.КодВозврата) 
		И лРеквизиты.КодВозврата <> лРеквизиты.АктРассмотренияВозвратаКодВозврата 
		И  лРеквизиты.АктРассмотренияВозвратаСтатусДокумента = Справочники.СтатусыДокументов.АРВ_ГВЖдемТовар
		И лРеквизиты.СтатусДокумента = Справочники.СтатусыДокументов.ВозвратТоваровОтПокупателяПринят Тогда
		...
		Перечисления.ВидыСобытийКОбработкеПроцессаВозвратов.ОбновлениеКодаВозвратаИзТоплог, 
		Ссылка);
		
	ИначеЕсли  лРеквизиты.АктРассмотренияВозвратаСтатусДокумента = Справочники.СтатусыДокументов.АРВ_ГВЖдемТовар
		И лРеквизиты.СтатусДокумента = Справочники.СтатусыДокументов.ВозвратТоваровОтПокупателяОтказ Тогда
		
		//Установка отказа
		РегистрыСведений.СобытияКОбработкеАктовРассмотренияВозврата.Добавить(лРеквизиты.АктРассмотренияВозврата, 
		Перечисления.ВидыСобытийКОбработкеПроцессаВозвратов.УстановкаОтказаИзТоплог, 
		Ссылка);
