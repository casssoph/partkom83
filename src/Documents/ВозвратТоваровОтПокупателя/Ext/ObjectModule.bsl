...
ЗапросСценами = новый Запрос("ВЫБРАТЬ
                             ...
                             |			ТОГДА ЦеныНоменклатурыСрезПоследних.Цена * ВТДанныеИПродажи.КоличествоВозврат
                             ...
                             |				&Момент,
                             |				(Номенклатура, ТипЦен, Валюта) В
                             |					(ВЫБРАТЬ
                             |						ВТДанныеИПродажи.Номенклатура КАК Номенклатура,
                             |						ЗакупочныйТипЦенРуб.Значение КАК ТипЦены,
                             ...
                             |					ГДЕ
                             |						ВТДанныеИПродажи.Себестоимость = 0)) КАК ЦеныНоменклатурыСрезПоследних
                             |		ПО (ЦеныНоменклатурыСрезПоследних.Номенклатура = ВТДанныеИПродажи.Номенклатура)
