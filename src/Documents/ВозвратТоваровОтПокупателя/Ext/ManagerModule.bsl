...
Функция ОпределитьВидОперации(Контрагент) Экспорт
	
	Если ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Контрагент, "ОбратнаяРеализацияПриВозвратеОтКлиента") = Истина Тогда
...
Функция ПодготовитьДанныеДляПечатиУниверсальногоКорректировочногоДокумента(Ссылка) Экспорт
	...
	"Ссылка,Дата,ВидОперации,Организация,Контрагент,ДоговорКонтрагента,ДокументОснование,ДокументОснование.Номер,ДокументОснование.Дата,ДокументОснование.УчитыватьНДС");
		...
		Для каждого СтрокаПродажи Из СтрокиПродажи Цикл
			...
			Если УчитыватьСуммуВозвратов Тогда				
				СтрокаПродажи.СуммаДоИзменения = СтрокаПродажи.СуммаДоИзменения - 
													?(СтрокаВозврата.Количество = КВозврату, 
