...
Процедура ТоварыЦенаПриИзменении(Элемент)
	...
	ПересчитатьЦенуСУценкойСтрокиТабличнойЧасти(СтрокаТабличнойЧасти);
...
&НаКлиенте
Процедура ПересчитатьЦенуСУценкойСтрокиТабличнойЧасти(СтрокаТабличнойЧасти)
	
	СтрокаТабличнойЧасти.ЦенаПослеУценки = СтрокаТабличнойЧасти.Цена - Окр(СтрокаТабличнойЧасти.Цена*СтрокаТабличнойЧасти.ПроцентУценки/100, 2);
