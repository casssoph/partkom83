...
Функция ДокументыВозвратаОтПокупателяПоАРВ(СсылкаНаДокумент, ТекстУсловия = "") Экспорт
...
Функция ДокументыПеремещенияТоваровПоАРВ(СсылкаНаДокумент, ТекстУсловия = "") Экспорт
