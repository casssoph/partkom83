...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если СтатусДокумента = Справочники.СтатусыДокументов.АРВ_Новый Тогда
		...
		//		проведен документ "Акт рассмотрения возврата" (АРВ) в статусе "Новый"
		//И на основании этого АРВ не создан документ "Возврат от покупателя"
		//И в регистре сведений "История заявок покупателя" нет записи с этим состоянием ("Возврат: на рассмотрении")
