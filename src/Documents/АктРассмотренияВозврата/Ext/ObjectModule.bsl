...
Функция ОстаткиПартийПоРазмещениям() Экспорт
	...
	|	АктРассмотренияВозвратаТовары.Номенклатура,
	|	-ВЫБОР
	|		КОГДА АктРассмотренияВозвратаТовары.Ссылка.КодВозвратаОбновленИзТоплог = Ложь
	...
	//ХудинВВ XX-3071 05082019 ((
	СтатусВозвратПринятРазмещен = Новый Массив;
	СтатусВозвратПринятРазмещен.Добавить(Справочники.СтатусыДокументов.ВозвратТоваровОтПокупателяПринят);
	СтатусВозвратПринятРазмещен.Добавить(Справочники.СтатусыДокументов.ВозвратТоваровОтПокупателяРазмещен);
	Запрос.УстановитьПараметр("СтатусВозвратПринятРазмещен", СтатусВозвратПринятРазмещен);
	//))
