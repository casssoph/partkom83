...
Функция ОстаткиТоваровПоЗаявкеКорректировке(ДокументЗаполнения, Склад, ДатаОстатков)
	...
	|	втОсобыеУсловияОтсрочки.ДопустимоеЧислоДнейЗадолженности КАК ДопустимоеЧислоДнейЗадолженностиОУ,
	|	втОсобыеУсловияОтсрочки.ВидРасчетаДней КАК ВидРасчетаДнейОУ,
...
Функция ИнициализироватьПараметрыСозданияДокументовПоЗаявке() Экспорт
	...
	ПараметрыСоздания.Вставить("ВыбиратьСклад", Истина);
