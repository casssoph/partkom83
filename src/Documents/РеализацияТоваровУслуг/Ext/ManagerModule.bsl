...
// + Пушкин 20180612 XX-1499				   	
	...
	Выборка = МассивРезультатов[МассивРезультатов_Количество - 1].Выгрузить();
	Выборка_ОтказыКрупногабарит = МассивРезультатов[МассивРезультатов_Количество - 2].Выгрузить();
	SMSоповещение.СформироватьSMS_ОтказГрупногабарит(Выборка_ОтказыКрупногабарит);
// - Пушкин 20180612 XX-1499				   
