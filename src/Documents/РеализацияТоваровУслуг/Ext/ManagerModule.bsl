...
Функция ОстаткиТоваровПоЗаявкеКорректировке(ДокументЗаполнения, Склад, ДатаОстатков)
	...
	Запрос.УстановитьПараметр("ДоговорКонтрагента", ДоговорКонтрагентаВзаиморасчетов);
...
Функция ДатаОплатыДляДокумента(ДокументОбъект) Экспорт
	...
	ДопустимоеЧислоДнейЗадолженностиОУ = Справочники.ДоговорыКонтрагентов.ДопустимоеЧислоДнейЗадолженностиОсобыеУсловия(ДоговорВзаиморасчетов, ДокументОбъект.Товары.Выгрузить().Скопировать(,"Номенклатура, СтрокаЗаявки"), ДокументОбъект.Дата);
