...
Процедура ПриЗаписи(Отказ)
	...
	Если Не ДополнительныеСвойства.Свойство("НеОбрабатыватьМЗПриОтменеРТУ") Тогда 
		ФормированиеСлужебныхЗаданийКлиентСервер.ОбработатьМЗПриОтменеРТУ(ЭтотОбъект);
	КонецЕсли;
