...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.АктРассмотренияВозврата") Тогда
		...
		Если Реквизиты.ВариантСписания <> Перечисления.ВариантыСписанияВозврата.ПродажаНаВиновноеЛицо Тогда
			 ВызватьИсключение "Реализацию можно ввести только для варианта списания ""Продажа на виновное лицо""";
		КонецЕсли;
		...
		Если Не ЗначениеЗаполнено(Склад) Тогда
			ВызватьИсключение "Не определен склад для списания товаров";
		КонецЕсли;
		...
		Если Не ЗначениеЗаполнено(ДоговорКонтрагента) Тогда
			ВызватьИсключение "Не определен основной договор контрагента "+Контрагент;
		КонецЕсли;
