...
Функция ПечатьТОРГ12(БезУслуг = Ложь, Макет = Неопределено) Экспорт
		...
		|	ВЫБОР
		|		КОГДА естьNULL(РеализацияТоваровУслуг.ДоговорКонтрагента.ДоговорНаОферту,ЛОЖЬ) = ИСТИНА И НЕ естьNULL(РеализацияТоваровУслуг.ДоговорКонтрагента.ДатаДоговораОферты,ДАТАВРЕМЯ(1,1,1,0,0,0)) = ДАТАВРЕМЯ(1,1,1,0,0,0) ТОГДА РеализацияТоваровУслуг.ДоговорКонтрагента.ДатаДоговораОферты
