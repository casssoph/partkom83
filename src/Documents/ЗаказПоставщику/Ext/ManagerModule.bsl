...
КонецПроцедуры
Процедура ЗаписатьКорректировкуЗаказа(ПоследнийДокументЗаказа, СтрокиДокументаЗаказа, ТаблицаОтказов, ДокументКорректировки=Неопределено) //Семенов И.П. 01.02.2019 XX-1768 ДокументКорректировки
