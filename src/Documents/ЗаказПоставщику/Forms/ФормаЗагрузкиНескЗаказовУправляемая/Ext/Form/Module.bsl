...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Перем Таблица;
	 лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ПриСозданииНаСервере";
...
Процедура ПеренестиВДокумент(Команда)
	 лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ПеренестиВДокумент";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Функция ПоместитьТЧВоВременноеХранилище()
	лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ПоместитьТЧВоВременноеХранилище";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
...
Процедура ТоварыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	 лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ТоварыВыбор";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Функция ПолучитьПоследнийДокументКорректировки(Заявка)
	лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ПолучитьПоследнийДокументКорректировки";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Процедура ТолькоРазличияПриИзменении(Элемент)
	 лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ТолькоРазличияПриИзменении";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ЗаполнитьИзТаблицыНаСервере()
	 лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ЗаполнитьИзТаблицыНаСервере";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ТоварыКоличествоПриИзменении(Элемент)
	 лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ТоварыКоличествоПриИзменении";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ТоварыПриОкончанииРедактированияНаСервере(ИдентфикаторСтроки)
	 лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ТоварыПриОкончанииРедактированияНаСервере";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
...
Процедура ТоварыПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	 лКлючАлгоритма = "Документ_ЗаказПоставщику_ФормаЗагрузкиНескЗаказовУправляемая_ТоварыПриОкончанииРедактирования";
	 лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	 Если Не лЗамена = Неопределено Тогда
	 	Выполнить(лЗамена);
	 	Возврат;
