...
Функция GetData(date, User) Экспорт 
    ...
    Запрос.Текст =
        ...
        |	МаршрутноеЗадание_Док.ЗаказПокупателя.Номер КАК CustomerOrderNumber,
    ...
    Пока Выборка.Следующий() Цикл
		...
		ТаблицаТоваров.Колонки.Добавить("ХарактеристикаНоменклатуры", 	Новый ОписаниеТипов(МассивТипов));
		МассивТипов.Очистить();
		...
		//	КонецЕсли;
			Для Каждого СтрокаТЧ из ТаблицаТоваров цикл
				...
				Товар.CharID		= XMLСтрока(СтрокаТЧ.ХарактеристикаНоменклатуры.УникальныйИдентификатор());
				Товар.CharName 		= XMLСтрока(СтрокаТЧ.ХарактеристикаНоменклатуры.Наименование);
