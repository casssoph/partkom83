...
Процедура УстановитьРеквизитыОтчета(СтруктураОтчета)
	...
	СтруктураОтчета.Вставить("КонтрагентТекст", СтруктураОтчета.Контрагент.НаименованиеПолное+" ("+СтруктураОтчета.Контрагент.Код+")");
...
Процедура УстановитьКонтактнуюИнформацию(СтруктураОтчета)
	...
	СтруктураОтчета.Вставить("EMail", ?(ЕстьДанные, Выборка.EMail, "-")+"; natalia.sattarova@part-kom.ru");
