...
Функция ПолучитьСписокПоставщиковКРассылке()
	...
	Запрос.УстановитьПараметр("ДатаНачала", ПолныеПрава.ОбщаяДатаЗапретаРедактирования());
...
Функция ПолучитьДанныеОтчета(Поставщик,Организация) Экспорт 
	...
	ПериодОтчета.ДатаНачала = ПолныеПрава.ОбщаяДатаЗапретаРедактирования();
