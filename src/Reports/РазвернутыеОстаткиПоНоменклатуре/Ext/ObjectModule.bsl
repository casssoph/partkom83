...
Процедура ЗаполнитьДеревоОстатков(ДеревоОстатков, ТекущаяНоменклатура) Экспорт
	...
	//|	ВЫБОР
	//|		КОГДА Заявки.СтрокаЗаявки.ПоследняяКорректировка = ЗНАЧЕНИЕ(Документ.КорректировкаЗаявкиПокупателя.ПустаяСсылка)
	//|				ИЛИ Заявки.СтрокаЗаявки.ПоследняяКорректировка ЕСТЬ NULL
	//|			ТОГДА Заявки.СтрокаЗаявки.Заявка
	//|		ИНАЧЕ Заявки.СтрокаЗаявки.ПоследняяКорректировка
	//|	КОНЕЦ КАК Заявка,
	...
	|	Заявки.СтрокаЗаявки.СостояниеЗаказа КАК СостояниеЗаказа,
	...
	//|	МАКСИМУМ(КорректировкаЗаказаПоставщику.Дата) КАК ДатаПоследнейКорректировки
	//|ПОМЕСТИТЬ КорректировкиЗаказов_Даты
	//|ИЗ
	...
	//|			ИЗ
	//|				ТабОстатков_0)
	//|	И КорректировкаЗаказаПоставщику.ПометкаУдаления = ЛОЖЬ
	//|	И КорректировкаЗаказаПоставщику.Проведен = ИСТИНА
	//|
	//|СГРУППИРОВАТЬ ПО
	//|	КорректировкаЗаказаПоставщику.ДокументОснование
	//|;
	...
	//|////////////////////////////////////////////////////////////////////////////////
	//|ВЫБРАТЬ
	//|	КорректировкаЗаказаПоставщику.ДокументОснование КАК Заказ,
	//|	КорректировкаЗаказаПоставщику.Ссылка КАК ПоследняяКорректировкаЗаказа
	//|ПОМЕСТИТЬ КорректировкиЗаказов_Ссылки
	//|ИЗ
	//|	Документ.КорректировкаЗаказаПоставщику КАК КорректировкаЗаказаПоставщику
	//|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ КорректировкиЗаказов_Даты КАК КорректировкиЗаказов_Даты
	//|		ПО КорректировкаЗаказаПоставщику.ДокументОснование = КорректировкиЗаказов_Даты.ДокументОснование
	//|			И КорректировкаЗаказаПоставщику.Дата = КорректировкиЗаказов_Даты.ДатаПоследнейКорректировки
	//|ГДЕ
	//|	КорректировкаЗаказаПоставщику.ДокументОснование В
	//|			(ВЫБРАТЬ
	//|				ТабОстатков_0.Заказ
	//|			ИЗ
	//|				ТабОстатков_0)
	//|	И НЕ КорректировкаЗаказаПоставщику.Ссылка ЕСТЬ NULL
	//|	И НЕ КорректировкаЗаказаПоставщику.Ссылка = ЗНАЧЕНИЕ(Документ.КорректировкаЗаказаПоставщику.ПустаяСсылка)
	//|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	//|	ВЫБОР
	//|		КОГДА КорректировкиЗаказов_Ссылки.ПоследняяКорректировкаЗаказа = ЗНАЧЕНИЕ(Документ.КорректировкаЗаказаПоставщику.ПустаяСсылка)
	//|				ИЛИ КорректировкиЗаказов_Ссылки.ПоследняяКорректировкаЗаказа ЕСТЬ NULL
	//|			ТОГДА ТабОстатков_0.Заказ
	//|		ИНАЧЕ КорректировкиЗаказов_Ссылки.ПоследняяКорректировкаЗаказа
	//|	КОНЕЦ КАК Заказ,
	...
	//|		ЛЕВОЕ СОЕДИНЕНИЕ КорректировкиЗаказов_Ссылки КАК КорректировкиЗаказов_Ссылки
	//|		ПО ТабОстатков_0.Заказ = КорректировкиЗаказов_Ссылки.Заказ
