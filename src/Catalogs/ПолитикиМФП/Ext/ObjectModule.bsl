...
Процедура ПередЗаписью(Отказ)
	...
	КолРегистраций = СобственныеОрганизацииРазрешенаПокупка.Количество();
	СобственныеОрганизацииРазрешенаПокупкаСтрокой = ?(КолРегистраций = 0, "", "Разрешена покупка у "+КолРегистраций+" организаций");
