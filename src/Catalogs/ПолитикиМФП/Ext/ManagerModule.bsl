...
Функция СтруктураСтрокиПравил()
	...
	СтруктураСтрокиПравил = Новый Структура("ОрганизацияПродавецСписаниеПартий, ОрганизацияПокупательСписаниеПартий, ОрганизацияПродавец, ОрганизацияПокупатель, ПроцентНаценки, Политика, Порядок, СпособПередачиТоваров, ДоговорКонтрагента, ПолитикаРазрешенаЦепочкаЗакупок");
