...
Функция ДоступныеВзаимосвязиТекущегоСтатуса(ТекущийСтатус) Экспорт
...
Функция ТаблицаКомандДляТекущегоСтатуса(ТекущийСтатус, Знач Пользователь = Неопределено) Экспорт
	...
	Запрос.Текст = 
		...
		|	ВзаимосвязиСтатусовПроцессаВозвратаОтПокупателя.Наименование КАК НаименованиеКоманды,
		...
		|		ПО (Пользователи.ГруппаДоступаКСтатусамПроцессаВозвратаОтПокупателя = ГруппыДоступаКСтатусам.Ссылка)
