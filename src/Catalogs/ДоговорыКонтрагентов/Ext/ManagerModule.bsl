Функция ПолучитьРеквизитыКонтроля(МетаданныеОтбора) Экспорт
	...
	лКлючАлгоритма = "Справочник_ДоговорыКонтрагентов_МодульМенеджера_ПолучитьРеквизитыКонтроля";
	...
	Если МетаданныеОтбора = Метаданные.ПланыОбмена.ОбменПартКом83_Сайт Тогда
		...
		|ВременнаяОтсрочка_ДопустимоеЧислоДнейЗадолженности,
		|ВременнаяОтсрочка_Использовать,
		|ВременнаяОтсрочка_СрокДействия");
	КонецЕсли;
