...
Функция НередактируемыеРеквизитыДоговоровПодчиненныхКонтрагентов() Экспорт
	 ...
	 НередактируемыеРеквизиты.Добавить("ЗапретРедактированияЛимита");
	 НередактируемыеРеквизиты.Добавить("КоэффициентСуммыКредита");
	 НередактируемыеРеквизиты.Добавить("НеКонтролироватьЛимит");
	 НередактируемыеРеквизиты.Добавить("ДопустимаяСуммаЗадолженности");
