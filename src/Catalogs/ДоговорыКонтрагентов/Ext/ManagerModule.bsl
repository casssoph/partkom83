Функция ПолучитьРеквизитыКонтроля(МетаданныеОтбора) Экспорт
	...
	Если МетаданныеОтбора = Метаданные.ПланыОбмена.ОбменПартКом83_Сайт Тогда
		СтруктураПроверяемыхРеквизитов.Вставить("Шапка", "Наименование,Код,Владелец,Дата,Номер,Организация,СрокДействия,ДопустимаяСуммаЗадолженности,КоэффициентСуммыКредита,ДоговорПриостановлен,ПометкаУдаления,ДоговорПодписан,СлужебныйДоговор,Организация,БанковскийСчет");
	КонецЕсли;
