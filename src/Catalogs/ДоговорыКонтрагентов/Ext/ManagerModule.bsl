...
Функция ДанныеОбъектовПланаОбмена(ТаблицаСсылокНаОбъекты)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      ...
	                      |			ТОГДА СПодчиненнымиДоговорами.Ссылка.БанковскийСчет.НомерСчета
	                      |		ИНАЧЕ ЕСТЬNULL(СПодчиненнымиДоговорами.Ссылка.Организация.ОсновнойБанковскийСчет.НомерСчета, """")
