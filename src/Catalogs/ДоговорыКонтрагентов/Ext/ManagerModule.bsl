...
Функция ДанныеОбъектовПланаОбмена(ТаблицаСсылокНаОбъекты)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
	                      ...
	                      |	СПодчиненнымиДоговорами.Ссылка.ДопустимоеЧислоДнейЗадолженности КАК ДопустимоеЧислоДнейЗадолженности,
	                      |	СПодчиненнымиДоговорами.Ссылка.ВременнаяОтсрочка_Использовать КАК ВременнаяОтсрочка_Использовать,
	                      |	СПодчиненнымиДоговорами.Ссылка.ВременнаяОтсрочка_ДопустимоеЧислоДнейЗадолженности КАК ВременнаяОтсрочка_ДопустимоеЧислоДнейЗадолженности,
	                      |	СПодчиненнымиДоговорами.Ссылка.ВременнаяОтсрочка_СрокДействия КАК ВременнаяОтсрочка_СрокДействия
	                      |ИЗ
	                      |	СПодчиненнымиДоговорами КАК СПодчиненнымиДоговорами
