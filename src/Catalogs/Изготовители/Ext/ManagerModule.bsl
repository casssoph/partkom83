...
Процедура ЗагрузитьЭлемент(вхОбъектXDTO, вхОтправитель) Экспорт
	...
	лКлючАлгоритма = "Справочник_Изготовители_МодульМенеджера_ЗагрузитьЭлемент";
...
Функция ТаблицаЗамен() Экспорт
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	Изготовители.Ссылка КАК ИзготовительСсылка,
		|	Изготовители.Ссылка.Наименование КАК Изготовитель,
		|	Изготовители.Замена КАК ЗаменаСсылка,
		|	Изготовители.Замена.Наименование КАК Замена
		|ИЗ
		|	Справочник.Изготовители КАК Изготовители
		|ГДЕ
		|	Изготовители.ВыведенИзОбращения 
		|	И НЕ Изготовители.Замена = Значение(Справочник.Изготовители.ПустаяСсылка)";
