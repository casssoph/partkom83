...
Процедура ВыполнитьПроверкиПередЗаписью(Отказ)
	...
	Если ЗначениеЗаполнено(СкладВозвратов) И СкладВозвратов.ОсновнойСкладРегиона Тогда
		 ВызватьИсключение "В качестве склада возвратов не может быть указан основной склад!";
	КонецЕсли;
