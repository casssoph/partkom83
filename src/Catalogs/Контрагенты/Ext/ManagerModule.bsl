...
// 16.04.19 Строганов Роман <
	...
	ИначеЕсли МетаданныеОтбора = Метаданные.ПланыОбмена.ОбменПартКом83_БитФинанс Тогда
		СтруктураПроверяемыхРеквизитов.Вставить("Шапка", "Код,Наименование,ИНН,КПП,Комментарий,НаименованиеПолное,Покупатель,Поставщик,ЮрФизЛицо,ОсновнойДоговорКонтрагента,ОсновнойДоговорКонтрагентаЗакупка");
	Иначе
