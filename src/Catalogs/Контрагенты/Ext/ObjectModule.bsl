...
Процедура ПриЗаписи(Отказ)
	...
	//		ОбменДаннымиКлиентСервер.ЗарегистрироватьОбъект(ОсновнойДоговорКонтрагента.ПолучитьОбъект(), Метаданные.ПланыОбмена.ОбменПартКом83_77);
	//	КонецЕсли;
	//	
	//	Если ЗначениеЗаполнено(ОсновнойДоговорКонтрагентаЗакупка) тогда
	//		ОбменДаннымиКлиентСервер.ЗарегистрироватьОбъект(ОсновнойДоговорКонтрагентаЗакупка.ПолучитьОбъект(), Метаданные.ПланыОбмена.ОбменПартКом83_77);
	//	КонецЕсли;
	//	
	//КонецЕсли;
	...
	Если РегистрыСведений.НастройкиПодсистем.ЗначениеПараметра("Обмен 1С-Elma", "Выгружать контрагентов при записи", Ложь) Тогда
