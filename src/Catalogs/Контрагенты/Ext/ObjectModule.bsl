...
// + Пушкин 20181212 XX-1455
	ЛогПредставлениеРазличий = -1;//"";
	ЗалогироватьЭД = ОбменДаннымиКлиентСервер.ЕстьРазличияСсылкиИОбъекта(ЭтотОбъект, "ЛогированиеЗначенийЭД", ЛогПредставлениеРазличий);
	Если ЗалогироватьЭД тогда
		//Попытка
		//		
		//Исключение
		//КонецПопытки;
