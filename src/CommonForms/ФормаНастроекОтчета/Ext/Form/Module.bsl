...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЦветНеактивныхЗначенийТаблицы = ЦветаСтиля.ЦветРамки;
...
Процедура ЗапуститьСценарий(Сценарий)
	...
	Если ТипЗнч(Сценарий.Шаги) = Тип("Строка") Тогда
		Сценарий.Шаги = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(Сценарий.Шаги, ",", Истина);
	КонецЕсли;
...
Функция ВыполнитьШаг(ВыборПользователя, Сценарий)
	...
	Если СокрЛП(Сценарий.ТекущийШаг) = "ОпределитьВыделенныеСтроки" Тогда
		Возврат ШагОпределитьВыделенныеСтроки(ВыборПользователя, Сценарий);
	
	ИначеЕсли СокрЛП(Сценарий.ТекущийШаг) = "ОтредактироватьГруппуПолей" Тогда
		Возврат ШагОтредактироватьГруппуПолей(ВыборПользователя, Сценарий);
	
	ИначеЕсли СокрЛП(Сценарий.ТекущийШаг) = "СгруппироватьСтроки" Тогда
		Возврат ШагСгруппироватьСтроки(ВыборПользователя, Сценарий);
	
	ИначеЕсли СокрЛП(Сценарий.ТекущийШаг) = "СдвинутьСтроки" Тогда
		Возврат ШагСдвинутьСтроки(ВыборПользователя, Сценарий);
	
	ИначеЕсли СокрЛП(Сценарий.ТекущийШаг) = "УдалитьСтроки" Тогда
		Возврат ШагУдалитьСтроки(ВыборПользователя, Сценарий);
	
	ИначеЕсли СокрЛП(Сценарий.ТекущийШаг) = "ОбновитьФорму" Тогда
...
Функция ШагОбновитьФорму(ВыборПользователя, Сценарий)
	Сценарий.Вставить("ИмяСобытия", СокрЛП(Сценарий.ТаблицаИмя) + "." + Сценарий.Действие);
...
Процедура ТаблицыПолейПередУдалением(ТаблицаИмя, Отказ)
	...
	Сценарий.Вставить("ТаблицаИмя", СокрЛП(ТаблицаИмя));
...
Процедура ДобавитьУсловноеОформление()
	...
	Инструкция.Оформление.Вставить("ЦветТекста", ЦветаСтиля.ЦветРамки);
...
Процедура БыстрыеНастройкиЗапомнитьСостояние(ПараметрыЗаполнения)
	...
	ИменаТаблиц = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(ИменаТаблиц, ",", Истина);
