...
Процедура ЭкспрессДоставка_init(СтруктураОбъекта, СтруктураОтчета)
	...
	РубильникВключен = Истина;//РегистрыСведений.НастройкиПодсистем.ЗначениеПараметра("Обмен 1С-Сайт", "ПринудительноеПроведениеРТУExpressDeliveryНовыйВключить", Ложь);
...
Процедура ОформитьОтказыПоЗаявкам(парам_ТЧ, парам_СтрокиЗаявок = Неопределено)
	...
	Для каждого лРТУ из парам_ТЧ Цикл
