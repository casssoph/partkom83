...
Функция ЗагружаемыеОбъектыРеализации(СтруктураОбъекта)
	...
	Для Каждого Группировка Из ВыборкаПоГруппировкам Цикл
		// + Пушкин 20181114 XX-1345 
		НоваяСтруктураОбъекта = Новый Структура("RequestID,Контрагент,Дата,ДатаДоставки,ВремяДоставкиС,ВремяДоставкиПо,Телефон,Заказчик,ЭД_init,ЭД_ВидОплаты,АдресДоставки,ТорговаяТочка,Менеджер");
