...
Процедура ЭкспрессДоставка_add(СтруктураОбъекта, СтруктураОтчета)
	...
	Для Каждого СтруктураРеализации Из ЗагружаемыеОбъекты Цикл
		...
		ИначеЕсли ЗначениеЗаполнено(СтруктураОбъекта.РеализацияДляОбразца) Тогда
			...
			Документ.Источник = Перечисления.ИсточникиРеализаций.Сайт;
			ЗаполнитьЗначенияСвойств(Документ, СтруктураОбъекта.РеализацияДляОбразца, "express_delivery_request_id,ТипДоставки,Контрагент,Склад,ДатаДоставки,ДоговорКонтрагента,Организация,
