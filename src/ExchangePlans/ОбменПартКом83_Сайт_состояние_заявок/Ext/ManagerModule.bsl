...
Процедура УстановитьРеквизитыКонтрагента(СтруктураОбъекта, UUIDДоговора)
	...
	ДанныеДоговора = ДанныеДоговора(UUIDДоговора, СтруктураОбъекта.Контрагент, СтруктураОбъекта.ДоговорИзОсновногоДоговора, СтруктураОбъекта.Дата);
...
КонецПроцедуры
Функция ДанныеДоговора(UUID, Контрагент, ИспользоватьОсновнойДоговор, Дата)
	
	//28.06.2018: PaSe - Договор по умолчанию решили брать из основного договора контрагента//
	Если ИспользоватьОсновнойДоговор И ЗначениеЗаполнено(Контрагент.ОсновнойДоговорКонтрагента) Тогда
