...
Функция СтруктураДокументаЗаявкаПокупателя(ОбъектXDTO, НомерСообщения) Экспорт
	...
	УстановитьДоговорПоставщика(СтруктураОбъекта);  //ХудинВВ XX-2851 18072019 
...
Процедура УстановитьДоговорПоставщика(СтруктураОбъекта)
	...
	Если ЭтоАктивнаяЗадачаJirа(Справочники.ЗадачиJira.XX2851) И СтруктураОбъекта.ИсточникЗаявки = Перечисления.ИсточникиЗаявок.Inventor Тогда
		...
		Если СтруктураОбъекта.Товары.Количество() > 0 Тогда
			
			Прайс = СтруктураОбъекта.Товары[0].ПрайсПоставщика;
