...
Процедура УстановитьРеквизитыНоменклатуры(СтруктураОбъекта, Строка, UUID)
	...
	Строка.Номенклатура = НоменклатураПоUUID(Строка(UUID), СтруктураОбъекта, Строка.ПрайсПоставщика);
...
КонецФункции
Функция ДанныеНоменклатурыПоUUID(UUID, ПрайсПоставщика, Отказ)
	
	Заголовки = Новый Соответствие;
	Заголовки.Вставить("Content-Type", "application/x-www-form-urlencoded");
	
	Если ЗначениеЗаполнено(ПрайсПоставщика) Тогда
		ПараметрыЗапроса = "uuid=" + UUID + "&provider_uuid=" + Строка(ПрайсПоставщика.УникальныйИдентификатор());
	Иначе
...
КонецФункции
Функция НоменклатураПоUUID(UUID, СтруктураОбъекта, ПрайсПоставщика)
	...
	Иначе
		...
		ДокументDOM  = ДанныеНоменклатурыПоUUID(UUID, ПрайсПоставщика, Отказ);
		Если НЕ Отказ Тогда
