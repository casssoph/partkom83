...
Функция ОписаниеОрганизации(СписокСведений, Знач Список = "", СПрефиксом = Истина) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_ФормированиеПечатныхФорм_ОписаниеОрганизации";
...
Функция ПолучитьШаблонПисьмаПоИмениПечатнойФормы(ПечатнаяФорма,ОбъектПечати) Экспорт
	...
	ИначеЕсли ТипЗнч(ОбъектПечати) = Тип("ДокументОбъект.ВозвратТоваровПоставщику") или
		...
		Если ОбъектПечати.СозданИзАкта Тогда 
			Возврат Справочники.ШаблоныТекстовПисем.УниверсальныйПередаточныйДокумент;
		Иначе	
			Возврат Справочники.ШаблоныТекстовПисем.ВозвратПоставщику;
		КонецЕсли;	
