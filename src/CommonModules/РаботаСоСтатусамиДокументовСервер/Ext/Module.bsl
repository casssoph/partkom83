...
#Область Прочее
Функция ДоступныеКодыСписанияДокумента(ДокументСсылка) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_РаботаСоСтатусамиДокументовСервер_РаботаСоСтатусамиДокументовСервер";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
	...
	|						ИЛИ КодыСписания.Наименование ПОДОБНО ""6С / 2%""
