...
Функция ОпределитьНеобходимостьСдвигаГраницы(ДокументМоментВремени, ИмяПоследовательности, Отбор = Неопределено) Экспорт
	...
	//Сдвигаем если граница не установлена, или нет документов между границей и документом
	НужноСдвинуть = ГраницаМоментВремени.Период = Дата(1,1,1) ИЛИ Запрос.Выполнить().Пустой();
	
	Возврат НужноСдвинуть;
