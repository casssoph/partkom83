...
Функция ВыгрузитьВОкноПоставщика(СсылкаНаОбъект, СтруктураАдресаФайлов) Экспорт
	...
	ДатаВремяОбновленияАкта = СтрЗаменить(ПроцедурыОбменаДанными.ПеревернутьДату(ТекущаяДатаСеанса()), " ", "") + " " + СокрЛП(Формат(ТекущаяДатаСеанса(), "ДЛФ=T")); 
	ДатаВремяОбновленияВедомости = СтрЗаменить(ПроцедурыОбменаДанными.ПеревернутьДату(ТекущаяДатаСеанса()), " ", "") + " " + СокрЛП(Формат(ТекущаяДатаСеанса(), "ДЛФ=T"));
