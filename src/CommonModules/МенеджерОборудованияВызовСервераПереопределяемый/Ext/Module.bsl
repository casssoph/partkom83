...
Функция ИспользоватьВКСканераШК() Экспорт
	
	лКлючАлгоритма = "ОбщийМодуль_МенеджерОборудованияВызовСервераПереопределяемый_ИспользоватьВКСканераШК";
	...
	Возврат Константы.ИспользоватьВКСканераШК.Получить();
