...
#Область СлужебныеПроцедурыИФункциии

Функция ПользовательПринаджлежитКГруппе(Пользователь,ГруппаПользователей) экспорт
	
	лКлючАлгоритма = "ОбщийМодуль_Пользователи_ПользовательПринаджлежитКГруппе";
	...
	|	И ГруппыПользователейПользователиГруппы.Ссылка = &ГруппаПользователей";
