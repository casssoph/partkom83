...
Функция Авторазация(ТекстСообщения = "Выгрузка в") Экспорт 
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_Авторазация";
...
Функция ПолучитьСтруктуруДляАвторизации() Экспорт
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ПолучитьСтруктуруДляАвторизации";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
	...
	МассивПодстрок = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(ВходящаяСтрока, "/", Истина);
...
Процедура getAreaOfControls(Ид) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_getAreaOfControls";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура getSchedulingZones(Ид) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_getSchedulingZones";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ОбработатьГеозону(Геозона)
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ОбработатьГеозону";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
	...
	//Разбор координат
	МассивПодстрок = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(Геозона.area, "|", Истина);
	Для каждого Подстрока Из МассивПодстрок Цикл
		
		Координаты = СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(Подстрока, ",", Истина);
...
Процедура importVehicles(Ид, ТаблицаТранспорта,Отказ = Ложь) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_importVehicles";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
//&НаСервере
Функция ВыгрузитьДанныеПоТранспорту(МассивОграничений = Неопределено, Архивная = Истина, Склад=Неопределено) Экспорт

	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ВыгрузитьДанныеПоТранспорту";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
	...
	Запрос.Текст = "ВЫБРАТЬ
	               |	МегаЛогист_ХарактеристикиТранспортныхСредств.Ссылка.ТранспортноеСредство.Наименование + ""@"" + МегаЛогист_ХарактеристикиТранспортныхСредств.Склад.Код КАК name,
	               |	МегаЛогист_ХарактеристикиТранспортныхСредств.Ссылка.ТранспортноеСредство.Код + ""@"" + МегаЛогист_ХарактеристикиТранспортныхСредств.Склад.Код КАК externalId,
	               ...
	               |ГДЕ
	               |	МегаЛогист_ХарактеристикиТранспортныхСредств.Склад = &Склад";
...
Процедура importPerformers(Ид, ТаблицаТранспорта,Отказ = Ложь) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_importPerformers";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
//&НаСервере
Функция ВыгрузитьДанныеПоВодителям(МассивОграничений = Неопределено, ТаблицаВодителей = Неопределено,Склад=Неопределено) Экспорт

	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ВыгрузитьДанныеПоВодителям";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               |	МегаЛогист_ХарактеристикиВодителей.Водитель.Наименование + ""@"" + МегаЛогист_ХарактеристикиВодителей.Склад.Код КАК externalId,
	               |	30 КАК breakShift,
	               |	МегаЛогист_ХарактеристикиВодителей.Водитель.Наименование + ""@"" + МегаЛогист_ХарактеристикиВодителей.Склад.Код КАК login,
	               |	""123"" КАК password,
	               |	МегаЛогист_ХарактеристикиВодителей.Водитель.Наименование + ""@"" + МегаЛогист_ХарактеристикиВодителей.Склад.Код КАК name,
	               ...
	               |ГДЕ
	               |	МегаЛогист_ХарактеристикиВодителей.Склад = &Склад";
...
Процедура assignPerformersToVehicles(Ид, ТаблицаТранспорта,Отказ = Ложь) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_assignPerformersToVehicles";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура importSchedules(Ид, ТаблицаТранспорта, Дата ,Отказ = Ложь) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_importSchedules";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Функция ВыгрузитьДанныеПоНазначениям(МассивОграничений = Неопределено) Экспорт
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ВыгрузитьДанныеПоНазначениям";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Функция ВыгрузитьДанныеЗаказам(МассивОграничений = Неопределено, Склад = Неопределено) Экспорт
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ВыгрузитьДанныеЗаказам";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	МегаЛогист_МаршрутноеЗадание.КонтактноеЛицоКонтрагента КАК contactPerson,
...
Процедура save(Ид, ТаблицаТранспорта,Отказ = Ложь) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_save";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
	...
	Для Каждого СтрокаТЗ Из ТаблицаТранспорта Цикл
		...
		ЗаполнитьЗначенияСвойств(Клиент, СтрокаТЗ, , "contactPerson");
		Заказ.client = Клиент;
		...
		ЗаполнитьЗначенияСвойств(Локация, СтрокаТЗ, ,"latitude, longitude");
		Локация.name = СтрокаТЗ.locationName;
		Локация.latitude 	= Число(СтрокаТЗ.latitude);
		Локация.longitude 	= Число(СтрокаТЗ.longitude);
		Локация.globalId 	= СокрЛП(СтрокаТЗ.Контрагент.Код);
		...
		ТаблицаОграничений = ПолучитьОграничения(СтрокаТЗ.МаршрутноеЗадание);
		Если ТаблицаОграничений.Количество() > 0 Тогда
...
Функция ПолучитьОграничения(Заказ)
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ПолучитьОграничения";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Процедура start(Ид, Отказ, Склад, Дата) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_start";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Функция mx_status(Ид, Отказ) Экспорт
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_mx_status";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Функция getScheduleByAOCOnDate(Ид, Склад, Дата) Экспорт
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_getScheduleByAOCOnDate";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
...
Процедура delete(Ид, Склад, Дата) Экспорт
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_delete";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ПроверитьНаОшибку(Объект, Отказ, ДопСтрока = "", безВывода = Ложь)
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ПроверитьНаОшибку";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура РазобратьОбъект(Объект, Отказ, ДопСтрока, безВывода)
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_РазобратьОбъект";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Функция ЗаполнитьСтруктуруОшибок()
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_ЗаполнитьСтруктуруОшибок";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
	...
	СтруктураОшибок.Вставить("п1142", "Один или несколько заказов уже запланированы в системе");
	...
	СтруктураОшибок.Вставить("п1309", "Не удалось определить адрес водителя");
...
Функция РасчитатьПродолжительностьПогрузки(Таблица, ИмяКонтрагента = "name", Объем = "volume", ВремяПогрузки = "durationDrop") Экспорт
	...
	лКлючАлгоритма = "ОбщийМодуль_МегаЛогист_РаботаСМакоптра_РасчитатьПродолжительностьПогрузки";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
