...
Процедура  ЗагрузкаОбъекта_ПоступлениеТоваровУслуг(ДанныеОбъекта, СтруктураОтчета);
	...
	Если НЕ СтруктураОтчета.Ошибка Тогда
		...
		Документы.ПоступлениеТоваровУслуг.ЗагрузитьЭлемент(СтруктураДанныхСайта,ПланыОбмена.ОбменПартКом83_ОкноПоставщика.ПустаяСсылка(),СтруктураОтчета.Ошибка,МассивДокументов);		
