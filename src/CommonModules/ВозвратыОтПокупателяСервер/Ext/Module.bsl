...
Функция УсловияКомандыВыполнены(пКоманда, ДокументОбъект, ТекстОшибки = "", СообщатьОбОшибке = Истина) Экспорт
...
Функция ВыполнитьКомандуДляАРВ(пКоманда, пФорма = Неопределено, ДокументСсылка = Неопределено, ТекстОшибки = "") Экспорт
	...
	Если ЭтоКомандаИзмененияСтатуса Тогда
		Если НЕ УсловияКомандыВыполнены(пКоманда, ДокументОбъект, , Истина) Тогда
			 Успешно =  Ложь;
		КонецЕсли;
	КонецЕсли;
...
Функция ВыполнитьКомандуДляАРВВТранзакции( пКоманда, пФорма = Неопределено, ДокументСсылка = Неопределено, ТекстОшибки = "") Экспорт
	
	НачатьТранзакцию(РежимУправленияБлокировкойДанных.Управляемый);
	
	успешно = ВыполнитьКомандуДляАРВ(пКоманда, пФорма, ДокументСсылка, ТекстОшибки);
