...
Процедура ЗаполнитьОснование(ДанныеДокумента, ДанныеДляПечати) Экспорт
	...
	Иначе
		...
		ДоговорКонтрагента_Дата = ?(лПараметрыДоговора.ДоговорНаОферту, ?(ЗначениеЗаполнено(лПараметрыДоговора.ДатаДоговораОферты),лПараметрыДоговора.ДатаДоговораОферты,лПараметрыДоговора.Дата), лПараметрыДоговора.Дата);
