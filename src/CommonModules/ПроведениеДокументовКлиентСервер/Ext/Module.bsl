...
Функция СписатьПартииБезПерепроведения(вхСсылкаНаДокумент, вхОтказ, вхПараметры, вхФильтр, вхБазовая, СтруктураТаблиц) Экспорт 
...
Функция СписатьПартииПоСтрокеТаблицеСписания(Знач вхСсылкаНаДокумент, Знач ДатаДокумента, Знач ЗаполняемыеРеквизиты,  СтрокаТовары, Строки, ТаблицаДвижений)
	...
	Перем Индекс, КоличествоРаспределить, СписываемоеКоличество, СтрокаДвижений, СтрокаДвиженийПриход, СтрокаОст;
