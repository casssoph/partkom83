...
Функция УсловиеПроведенияРазмещенияПТУНаОснованииВозвратаМХ3(вхСсылкаНаДокумент, СозданНаОснованииМХ3, вхСсылкаНаДокументОснование = Неопределено) Экспорт
	...
	ЗаполненыВхНомераДокументов = ЗначениеЗаполнено(вхСсылкаНаДокумент.ДатаВходящегоДокумента) И ЗначениеЗаполнено(вхСсылкаНаДокумент.ДатаВходящегоДокументаСФ) И ЗначениеЗаполнено(вхСсылкаНаДокумент.НомерВходящегоДокумента) И ЗначениеЗаполнено(вхСсылкаНаДокумент.НомерВходящегоДокументаСФ);
