...
Функция ЕстьКириллицаВСтроке(СтрокаПроверки) Экспорт
	
	Для А = 0 По СтрДлина(СтрокаПроверки)-1 Цикл
		// русские буквы начинаются с кода 192
		Символ = Лев(Прав(СтрокаПроверки, СтрДлина(СтрокаПроверки) - А), 1);
...
Функция УбратьЛидирующиеНули(Знач Строка) Экспорт
   Если Лев(Строка, 1) = "0" Тогда
	   Возврат УбратьЛидирующиеНули(Прав(Строка, СтрДлина(Строка) - 1)); 
   Иначе
	   Возврат Строка;
   КонецЕсли;	
КонецФункции

Функция ДобавитьЛидирующиеНули(Знач Строка, Знач ДлинаСтроки) Экспорт 
	
	Если СтрДлина(Строка) >= ДлинаСтроки Тогда 
		Возврат Строка;
	КонецЕсли;
	
	Для Шаг = 1 По ДлинаСтроки - СтрДлина(Строка) Цикл 
		Строка = "0" + Строка;
	КонецЦикла;
...
Функция СоответствиеАнглийскихРусскихСимволовРаскладки() Экспорт
	
	лКлючАлгоритма = "ОбщийМодуль_СтроковыеФункцииКлиентСервер_СоответствиеАнглийскихРусскихСимволовРаскладки";
	...
	//Ключ - английский
	//Значение - русский
	СоответствиеАнглийскихРусскихСимволов = Новый Соответствие;
	СоответствиеАнглийскихРусскихСимволов.Вставить("q","й");
    СоответствиеАнглийскихРусскихСимволов.Вставить("w","ц");
    СоответствиеАнглийскихРусскихСимволов.Вставить("e","у");
    СоответствиеАнглийскихРусскихСимволов.Вставить("r","к");
    СоответствиеАнглийскихРусскихСимволов.Вставить("t","е");
    СоответствиеАнглийскихРусскихСимволов.Вставить("y","н");
    СоответствиеАнглийскихРусскихСимволов.Вставить("u","г");
    СоответствиеАнглийскихРусскихСимволов.Вставить("i","ш");
    СоответствиеАнглийскихРусскихСимволов.Вставить("o","щ");
    СоответствиеАнглийскихРусскихСимволов.Вставить("p","з");
    СоответствиеАнглийскихРусскихСимволов.Вставить("[","х");
    СоответствиеАнглийскихРусскихСимволов.Вставить("]","ъ");
    СоответствиеАнглийскихРусскихСимволов.Вставить("a","ф");
    СоответствиеАнглийскихРусскихСимволов.Вставить("s","ы");
    СоответствиеАнглийскихРусскихСимволов.Вставить("d","в");
    СоответствиеАнглийскихРусскихСимволов.Вставить("f","а");
    СоответствиеАнглийскихРусскихСимволов.Вставить("g","п");
    СоответствиеАнглийскихРусскихСимволов.Вставить("h","р");
    СоответствиеАнглийскихРусскихСимволов.Вставить("j","о");
    СоответствиеАнглийскихРусскихСимволов.Вставить("k","л");
    СоответствиеАнглийскихРусскихСимволов.Вставить("l","д");
    СоответствиеАнглийскихРусскихСимволов.Вставить(";","ж");
    СоответствиеАнглийскихРусскихСимволов.Вставить("'","э");
    СоответствиеАнглийскихРусскихСимволов.Вставить("z","я");
    СоответствиеАнглийскихРусскихСимволов.Вставить("x","ч");
    СоответствиеАнглийскихРусскихСимволов.Вставить("c","с");
    СоответствиеАнглийскихРусскихСимволов.Вставить("v","м");
    СоответствиеАнглийскихРусскихСимволов.Вставить("b","и");
    СоответствиеАнглийскихРусскихСимволов.Вставить("n","т");
    СоответствиеАнглийскихРусскихСимволов.Вставить("m","ь");
    СоответствиеАнглийскихРусскихСимволов.Вставить(",","б");
    СоответствиеАнглийскихРусскихСимволов.Вставить(".","ю");
	...
	Возврат СоответствиеАнглийскихРусскихСимволов;
	
КонецФункции

Функция ЗаменитьАнглийскиеСимволыРаскладкиНаРусские(вхТекст) Экспорт
	
	лКлючАлгоритма = "ОбщийМодуль_СтроковыеФункцииКлиентСервер_ЗаменитьАнглийскиеСимволыРаскладкиНаРусские";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
	...
	Если ТипЗнч(вхТекст) = Тип("Строка") Тогда
		
		СоответствиеАнглийскихРусскихСимволов = СоответствиеАнглийскихРусскихСимволовРаскладки();
		
		Результат = вхТекст;
		Для каждого КлючЗначение Из СоответствиеАнглийскихРусскихСимволов Цикл
...
Функция ЗаменитьРусскиеСимволыРаскладкиНаАнглийские(вхТекст) Экспорт
	
	лКлючАлгоритма = "ОбщийМодуль_СтроковыеФункцииКлиентСервер_ЗаменитьРусскиеСимволыРаскладкиНаАнглийские";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
	...
	Если ТипЗнч(вхТекст) = Тип("Строка") Тогда
		...
		Результат = вхТекст;
		Для каждого КлючЗначение Из СоответствиеАнглийскихРусскихСимволов Цикл
			Результат=СтрЗаменить(Результат,КлючЗначение.Значение, КлючЗначение.Ключ);
		КонецЦикла;
	КонецЕсли;
