...
Процедура ЗарегистрироватьВсеОбъектыДляОбмена(УзелОбмена) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ДатаОграниченийДляДокументов) Тогда
		...
		ОбменДаннымиКлиентСервер.ЗарегистрироватьИзмененияВПланеОбмена(УзелОбмена);
		//)Семенов И.П.
	Иначе
		...
		Для Каждого ЭлементСоставаПланаОбмена Из УзелОбмена.Метаданные().Состав Цикл
			...
			Если Метаданные.Документы.Содержит(МетаданныеОбмена) Тогда
				...
				Пока Выборка.Следующий() Цикл
					...
					ОбменДаннымиКлиентСервер.ЗарегистрироватьИзмененияВПланеОбмена(УзелОбмена, Выборка.ссылка);
					//)Семенов И.П.					
				КонецЦикла;
			...
			Иначе
				...
				ОбменДаннымиКлиентСервер.ЗарегистрироватьИзмененияВПланеОбмена(УзелОбмена, МетаданныеОбмена);
				//)Семенов И.П.	   
			КонецЕсли;			
