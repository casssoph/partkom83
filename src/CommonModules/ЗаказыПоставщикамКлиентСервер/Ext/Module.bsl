...
Процедура ЗаполнитьСтркутуруПараметровЗаполненияПоКонтрагенту(СтруктураПараметров,ДокументПоступление);
	...
	РеквизитыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументПоступление, "Контрагент,ДокументОснование,ВидОперацииПоступления");
	Контрагент =РеквизитыДокумента.Контрагент;
	ЗаказПоставщику = РеквизитыДокумента.ДокументОснование;
	...
	Если РеквизитыДокумента.ВидОперацииПоступления = Перечисления.ВидыПоступленияТоваров.ОтветХранение
