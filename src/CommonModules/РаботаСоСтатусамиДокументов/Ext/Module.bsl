...
//	Запрос.Текст = 
//		"ВЫБРАТЬ РАЗЛИЧНЫЕ
//		|	СвернутыеДанные.Регистратор КАК Регистратор,
//		|	СвернутыеДанные.СтрокаЗаявки
//		|ИЗ
//		|	(ВЫБРАТЬ РАЗЛИЧНЫЕ
...
//		|	
//		|	СГРУППИРОВАТЬ ПО
//		|		ИсторияЗаявокПокупателяСрезПоследних.СтрокаЗаявки) КАК СвернутыеДанные
//		|ИТОГИ ПО
//		|	Регистратор";
//	
//	РезультатЗапроса = Запрос.Выполнить();
...
//	
//	ЗапросКИзменению  = новый Запрос("ВЫБРАТЬ
//	                                 |	ИсторияЗаявокПокупателяСрезПоследних.СтрокаЗаявки КАК СтрокаЗаявки,
//	                                 |	ИсторияЗаявокПокупателяСрезПоследних.СтрокаПрихода,
//	                                 |	ИсторияЗаявокПокупателяСрезПоследних.Регистратор КАК Регистратор,
...
//	                                 |ИТОГИ ПО
//	                                 |	СтрокаЗаявки");	
//ЗапросКИзменению.УстановитьПараметр("МассивСтрокЗаявок",МассивСтрокЗаявок");
