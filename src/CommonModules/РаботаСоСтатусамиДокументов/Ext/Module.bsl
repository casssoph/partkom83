...
Функция УпорядочитьСписокЗаказов(вхСтруктураОтбора, вхСтруктураСтроки, вхЕдиныйСписокЗаказов, вхСписокЗаказов, вхАвторазмещение, вхОписаниеОшибки)
	...
	Если НЕ вхСтруктураОтбора.РаботаетЧерезОП Тогда
		...
		вхСписокЗаказов_ОтклонениеМеньшеПорога = ОбщегоНазначения.ОтобратьУпорядочитьТаблицуЗначений(вхСписокЗаказов, "ОтклонениеЦеныМодуль < "+ПорогОтклонения, "Срок, ДатаЗаказа");
		
		вхСписокЗаказов_ОтклонениеБольшеРавноПорога = ОбщегоНазначения.ОтобратьУпорядочитьТаблицуЗначений(вхСписокЗаказов, "ОтклонениеЦеныМодуль >= "+ПорогОтклонения, "Срок, ДатаЗаказа");
		...
		вхСписокЗаказов_Упорядоченный = ОбщегоНазначения.ЗагрузитьВТаблицуЗначений(вхСписокЗаказов_ОтклонениеБольшеРавноПорога, вхСписокЗаказов_ОтклонениеМеньшеПорога); 
...
Функция УпорядочитьДляКонтрагентаОП(вхСписокЗаказов, МаксОтклонение)
	...
	вхСписокЗаказов_ДоЛимита =  ОбщегоНазначения.ОтобратьУпорядочитьТаблицуЗначений(вхСписокЗаказов, "ОтклонениеЦеныМодуль < "+МаксОтклонение, "ОтклонениеЦеныМодуль, ОтклонениеЦены, Срок, ДатаЗаказа");

	вхСписокЗаказов_СверхЛимита =  ОбщегоНазначения.ОтобратьУпорядочитьТаблицуЗначений(вхСписокЗаказов, "ОтклонениеЦеныМодуль >= "+МаксОтклонение, "Срок, ДатаЗаказа, ОтклонениеЦеныМодуль, ОтклонениеЦены");
	
	Возврат ОбщегоНазначения.ЗагрузитьВТаблицуЗначений(вхСписокЗаказов_СверхЛимита, вхСписокЗаказов_ДоЛимита);
