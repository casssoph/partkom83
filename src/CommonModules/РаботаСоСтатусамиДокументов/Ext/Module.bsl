...
Функция РазместитьПоСпискуЗаказов(вхСтруктураОтбора, вхСтруктураСтроки, вхЕдиныйСписокЗаказов, вхСписокЗаказов, вхАвторазмещение, вхОписаниеОшибки)
	...
	Если НоваяСортировка Тогда
		...
		УпорядочитьСписокЗаказов(вхСтруктураОтбора, вхСтруктураСтроки, вхЕдиныйСписокЗаказов, вхСписокЗаказов, вхАвторазмещение, вхОписаниеОшибки);
...
Функция УпорядочитьСписокЗаказов(вхСтруктураОтбора, вхСтруктураСтроки, вхЕдиныйСписокЗаказов, вхСписокЗаказов, вхАвторазмещение, вхОписаниеОшибки)
