...
Функция УпорядочитьСписокЗаказов(вхСтруктураОтбора, вхСтруктураСтроки, вхЕдиныйСписокЗаказов, вхСписокЗаказов, вхАвторазмещение, вхОписаниеОшибки, МаксОтклонение)
	...
	Возврат вхСписокЗаказов_Упорядоченный;
