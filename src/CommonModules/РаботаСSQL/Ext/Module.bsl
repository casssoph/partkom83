...
Функция ВыполнитьЗапросSQL(ТекстЗапроса, вхПараметры = Неопределено) Экспорт
	...
	Если ЭтоАктивнаяЗадачаJirа(Справочники.ЗадачиJira.XX2449) Тогда
		...
		ОписаниеОшибки = РаботаСSQLСервер.ВыполнитьЗапросSQL(ТекстЗапроса, вхПараметры);
	Иначе
	...
	Если ЗначениеЗаполнено(ОписаниеОшибки) Тогда
		...
		Неопределено, 
		Справочники.СобытияДляОтправкиЭлектронныхПисем.ОшибкаЗапросаSQL,
		ОписаниеОшибки,
		,
		Истина,
		"",
		"ОбщийМодуль_РаботаСSQL_ВыполнитьЗапросSQL");
...
Функция СтрокаСоединенияSQL(вхПараметры = Неопределено) Экспорт
	...
	//ХудинВВ XX-2449 08072019
	Если ЭтоАктивнаяЗадачаJirа(Справочники.ЗадачиJira.XX2449) Тогда
		СтрокаСоединенияSQL = СтрокаСоединенияSQL_АутентификацияОС(вхПараметры);
	Иначе
...
//ХудинВВ XX-2449 08072019
Функция СтрокаСоединенияSQL_АутентификацияОС(вхПараметры = Неопределено) Экспорт
	...
	ПараметрыПодключения = РаботаСSQLСервер.ОпределитьПараметрыДляSQLПодключения(вхПараметры);
