...
Функция КорректировкаПоступленияТоваровУслугПодготовитьСтруктуруТаблицСторнирующихНДСЗаписей(СтруктураШапкиДокумента) 
...
Функция КорректировкаПоступленияТоваровУслугПодготовитьТаблицуВычетНДСЗаМинусомНалогаВключенногоВСтоимость(СтруктураШапкиДокумента, ТаблицаДокумента)
...
Функция КорректировкаПоступленияТоваровУслугПодготовитьТаблицуВычетНДССУчетомПропорции(СтруктураШапкиДокумента, ТаблицаДокумента)
	
	ТаблицаКоэффициентов = КорректировкаПоступленияТоваровУслугПодготовитьТаблицуКоэффициентов(СтруктураШапкиДокумента);
...
Функция КорректировкаПоступленияТоваровУслугПодготовитьТаблицуКоэффициентов(СтруктураШапкиДокумента)
...
Функция КорректировкаПоступленияТоваровУслугПодготовитьТаблицуВычетНДСНаОснованииДокумента(СтруктураШапкиДокумента, СтруктураТаблицДокумента)
...
Функция КорректировкаПоступленияТоваровУслугПодготовитьТаблицуКорректировочныеДвиженияНДС(СтруктураШапкиДокумента, СтруктураТаблицДокумента)
	...
	|	КорректировкаПоступленияТоваровУслугТовары.Номенклатура,
	|	КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС,
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.Сумма > 0
	|			ТОГДА КорректировкаПоступленияТоваровУслугТовары.СуммаНДСДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.СуммаНДС
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК НДС,
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.Сумма > 0
	|			ТОГДА КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.Сумма
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК Сумма,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Дата КАК Период,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Дата КАК ДатаСобытия,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Организация КАК Организация,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Контрагент КАК Покупатель,
	|	ВЫБОР
	...
	|	КорректировкаПоступленияТоваровУслугТовары.НомерСтроки,
	...
	|	КОНЕЦ КАК КодВидаОперации
	|ИЗ
	|	ВТТаблицаПоТоварам КАК КорректировкаПоступленияТоваровУслугТовары
	|ГДЕ
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка = &Ссылка
	|	И КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.Сумма > 0
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	КорректировкаПоступленияТоваровУслугУслуги.Номенклатура,
	|	КорректировкаПоступленияТоваровУслугУслуги.СтавкаНДС,
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугУслуги.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.Сумма > 0
	|			ТОГДА КорректировкаПоступленияТоваровУслугУслуги.СуммаНДСДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.СуммаНДС
	|		ИНАЧЕ 0
	|	КОНЕЦ,
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугУслуги.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.Сумма > 0
	|			ТОГДА КорректировкаПоступленияТоваровУслугУслуги.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.Сумма
	|		ИНАЧЕ 0
	|	КОНЕЦ,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка.Дата,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка.Дата,
	...
	|	КОНЕЦ,
	|	ЛОЖЬ,
	|	КорректировкаПоступленияТоваровУслугУслуги.НомерСтроки,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка,
	|	ВЫБОР
	|		КОГДА &СчетФактураДата < ДАТАВРЕМЯ(2015, 1, 1)
	|			ТОГДА """"
	|		ИНАЧЕ ""18""
	|	КОНЕЦ КАК КодВидаОперации
	|ИЗ
	|	ВТТаблицаПоУслугам КАК КорректировкаПоступленияТоваровУслугУслуги
	|ГДЕ
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка = &Ссылка
	|	И КорректировкаПоступленияТоваровУслугУслуги.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.Сумма > 0
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.Сумма < 0
	|			ТОГДА (КорректировкаПоступленияТоваровУслугТовары.СуммаНДСДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.СуммаНДС) * -1
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК НДС,
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.Сумма < 0
	|			ТОГДА (КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.Сумма) * -1
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК Сумма,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Дата КАК Период,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Организация КАК Организация,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Контрагент КАК Поставщик,
	|	КорректировкаПоступленияТоваровУслугТовары.НомерСтроки,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка КАК Регистратор
	|ИЗ
	|	ВТТаблицаПоТоварам КАК КорректировкаПоступленияТоваровУслугТовары
	...
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка = &Ссылка
	|	И КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугТовары.Сумма < 0
	//|	И (НЕ КорректировкаПоступленияТоваровУслугТовары.СчетУчета.Забалансовый)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугУслуги.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.Сумма < 0
	|			ТОГДА (КорректировкаПоступленияТоваровУслугУслуги.СуммаНДСДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.СуммаНДС) * -1
	|		ИНАЧЕ 0
	|	КОНЕЦ,
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугУслуги.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.Сумма < 0
	|			ТОГДА (КорректировкаПоступленияТоваровУслугУслуги.СуммаДоКорректировки - КорректировкаПоступленияТоваровУслугУслуги.Сумма) * -1
	|		ИНАЧЕ 0
	|	КОНЕЦ,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка.Дата,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка.Организация,
...
Функция КорректировкаПоступленияТоваровУслугПодготовитьТаблицуКорректировкаНДСПоПартиямЗапасов(СтруктураШапкиДокумента, СтруктураТаблицДокумента)
	...
	|	КорректировкаПоступленияТоваровУслугТовары.Склад КАК Склад,
	|	ЗНАЧЕНИЕ(Перечисление.ВидыЦенностей.ПустаяСсылка) КАК ВидЦенности,
	|	КорректировкаПоступленияТоваровУслугТовары.Номенклатура КАК Номенклатура,
	|	КорректировкаПоступленияТоваровУслугТовары.СерияНоменклатуры КАК СерияНоменклатуры,
	|	КорректировкаПоступленияТоваровУслугТовары.ХарактеристикаНоменклатуры КАК ХарактеристикаНоменклатуры,
	|	КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС,
	|	КорректировкаПоступленияТоваровУслугТовары.Количество - КорректировкаПоступленияТоваровУслугТовары.КоличествоДоИзменения КАК Количество,
	|	ВЫБОР
	|		КОГДА (НЕ КорректировкаПоступленияТоваровУслугТовары.Ссылка.СуммаВключаетНДС)
	...
	|		ИНАЧЕ КорректировкаПоступленияТоваровУслугТовары.Сумма - КорректировкаПоступленияТоваровУслугТовары.СуммаДоИзменения
	|	КОНЕЦ КАК Стоимость,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Дата КАК Период,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Организация КАК Организация,
	|	КорректировкаПоступленияТоваровУслугТовары.НомерСтроки,
	...
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20)
	|				ИЛИ КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20_120)
	|			ТОГДА 20 / 120
	|		КОГДА КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС18)
	|				ИЛИ КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС18_118)
	|			ТОГДА 18 / 118
	|		КОГДА КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС10)
	|				ИЛИ КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС10_110)
	|			ТОГДА 10 / 110
	|		ИНАЧЕ 0
	...
	|ГДЕ
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка = &Ссылка
	|	И (КорректировкаПоступленияТоваровУслугТовары.КоличествоДоИзменения - КорректировкаПоступленияТоваровУслугТовары.Количество <> 0
	|			ИЛИ КорректировкаПоступленияТоваровУслугТовары.СуммаНДСДоИзменения - КорректировкаПоступленияТоваровУслугТовары.СуммаНДС <> 0
	|			ИЛИ КорректировкаПоступленияТоваровУслугТовары.СуммаДоИзменения - КорректировкаПоступленияТоваровУслугТовары.Сумма <> 0)
	|	И КорректировкаПоступленияТоваровУслугТовары.КоличествоДоИзменения <> 0
//	|	И (НЕ КорректировкаПоступленияТоваровУслугТовары.СчетУчета.Забалансовый)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|	&СчетФактура,
	|	&СчетФактура,
	|	КорректировкаПоступленияТоваровУслугТовары.Склад,
	|	ЗНАЧЕНИЕ(Перечисление.ВидыЦенностей.ПустаяСсылка),
	|	КорректировкаПоступленияТоваровУслугТовары.Номенклатура,
	|	КорректировкаПоступленияТоваровУслугТовары.СерияНоменклатуры,
	|	КорректировкаПоступленияТоваровУслугТовары.ХарактеристикаНоменклатуры,
	|	КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС,
	|	КорректировкаПоступленияТоваровУслугТовары.Количество,
	|	ВЫБОР
	|		КОГДА (НЕ КорректировкаПоступленияТоваровУслугТовары.Ссылка.СуммаВключаетНДС)
	|			ТОГДА КорректировкаПоступленияТоваровУслугТовары.Сумма + КорректировкаПоступленияТоваровУслугТовары.СуммаНДС
	|		ИНАЧЕ КорректировкаПоступленияТоваровУслугТовары.Сумма
	|	КОНЕЦ,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Дата,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Организация,
	|	КорректировкаПоступленияТоваровУслугТовары.НомерСтроки,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка,
	|	ИСТИНА,
	|	ВЫБОР
	|		КОГДА КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20)
	|				ИЛИ КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20_120)
...
Функция КорректировкаПоступленияТоваровУслугПроверитьНаличиеКосвенныхРасходов(СтруктураШапкиДокумента)
...
Процедура КорректировкаПоступленияТоваровУслугСформироватьКорректировочныеДвиженияНДС(СтруктураШапкиДокумента, СтруктураТаблицДокумента, ЕстьКосвенныеРасходы, Движения)
	
	СтруктураТаблиц = КорректировкаПоступленияТоваровУслугПодготовитьТаблицуКорректировочныеДвиженияНДС(СтруктураШапкиДокумента, СтруктураТаблицДокумента);
	...
	Если СтруктураШапкиДокумента.ВосстановитьНДС Тогда
		КорректировкаПоступленияТоваровУслугСформироватьДвиженияЗаписьКнигиПродаж(СтруктураШапкиДокумента, СтруктураТаблиц.ТаблицаВосстановление, , Движения);	
	КонецЕсли;	
	
	Если ЕстьКосвенныеРасходы Тогда
		// НДС принят к вычету в пропорции определенной согласно п.4 ст.170 НК РФ
		ТаблицаВычетНДС = КорректировкаПоступленияТоваровУслугПодготовитьТаблицуВычетНДССУчетомПропорции(СтруктураШапкиДокумента, СтруктураТаблиц.ТаблицаВычет);
	Иначе
		// НДС будет предъявлен к вычету по строкам на увеличение стоимости	
		ТаблицаВычетНДС = СтруктураТаблиц.ТаблицаВычет;
	КонецЕсли;
	
	КорректировкаПоступленияТоваровУслугСформироватьДвиженияНДСПредъявленный(СтруктураШапкиДокумента, ТаблицаВычетНДС, , Движения);
			
КонецПроцедуры	

Процедура КорректировкаПоступленияТоваровУслугСформироватьИсправительныеДвижения(СтруктураШапкиДокумента, СтруктураТаблицДокумента, ЕстьКосвенныеРасходы, СтруктураТаблицСторноНДС, Движения)
	
	ИсправляемыйДокумент = УчетНДС.ПолучитьИсправляемыйДокументПоступления(СтруктураШапкиДокумента.ДокументПоступления);
	
	Если ТипЗнч(ИсправляемыйДокумент) = Тип("ДокументСсылка.КорректировкаПоступленияТоваровУслуг") Тогда
		
		// Сторно движений исправляемого документа
		КорректировкаПоступленияТоваровУслугСформироватьДвиженияЗаписьКнигиПродаж(СтруктураШапкиДокумента, СтруктураТаблицСторноНДС.КнигаПродаж, Истина, Движения);
		// Новые движения по исправленному корректировочному счету-фактуре
		КорректировкаПоступленияТоваровУслугСформироватьКорректировочныеДвиженияНДС(СтруктураШапкиДокумента, СтруктураТаблицДокумента, ЕстьКосвенныеРасходы, Движения);	
				
	Иначе	
						
		ТаблицаДокумента = КорректировкаПоступленияТоваровУслугПодготовитьТаблицуВычетНДСНаОснованииДокумента(СтруктураШапкиДокумента, СтруктураТаблицДокумента);
		...
		Если ЕстьКосвенныеРасходы Тогда
			// НДС принят к вычету в пропорции определенной согласно п.4 ст.170 НК РФ
			ТаблицаВычетНДС = КорректировкаПоступленияТоваровУслугПодготовитьТаблицуВычетНДССУчетомПропорции(СтруктураШапкиДокумента, ТаблицаДокумента);					
		Иначе
			// НДС будет предъявлен к вычету за минусом включенного в стомость
			ТаблицаВычетНДС = КорректировкаПоступленияТоваровУслугПодготовитьТаблицуВычетНДСЗаМинусомНалогаВключенногоВСтоимость(СтруктураШапкиДокумента, ТаблицаДокумента);
		КонецЕсли;;	
...
Процедура КорректировкаПоступленияТоваровУслугДвиженияПоРегистрамНДС(СтруктураШапкиДокумента, СтруктураТаблицСторноНДС, СтруктураТаблицДокумента, ЕстьКосвенныеРасходы, Движения)
	...
	Если СтруктураШапкиДокумента.ВидОперации = Перечисления.ВидыОперацийИсправленияПоступленияРеализации.ИсправлениеОшибки Тогда // Исправительный счет-фактура	
		...
		// Сторно движений исправляемого документа
		КорректировкаПоступленияТоваровУслугСформироватьДвиженияЗаписьКнигиПокупок(СтруктураШапкиДокумента, СтруктураТаблицСторноНДС.КнигаПокупок, Движения);
		КорректировкаПоступленияТоваровУслугСформироватьДвиженияНДСПредъявленный(СтруктураШапкиДокумента, СтруктураТаблицСторноНДС.НДСПредъявленный, Истина, Движения);
		
		КорректировкаПоступленияТоваровУслугСформироватьИсправительныеДвижения(СтруктураШапкиДокумента, СтруктураТаблицДокумента, ЕстьКосвенныеРасходы, СтруктураТаблицСторноНДС, Движения);
	...
	ТаблицаКорректировкаНДСПоПартиямЗапасов = КорректировкаПоступленияТоваровУслугПодготовитьТаблицуКорректировкаНДСПоПартиямЗапасов(СтруктураШапкиДокумента, СтруктураТаблицДокумента);
	КорректировкаПоступленияТоваровУслугСформироватьДвиженияКорректировкаНДСПоПартиямЗапасов(СтруктураШапкиДокумента, ТаблицаКорректировкаНДСПоПартиямЗапасов, Движения);
		
КонецПроцедуры		

Процедура КорректировкаПоступленияТоваровУслугСформироватьДвиженияЗаписьКнигиПокупок(СтруктураШапкиДокумента, ТаблицаДвижений, Движения)
...
Процедура КорректировкаПоступленияТоваровУслугСформироватьДвиженияЗаписьКнигиПродаж(СтруктураШапкиДокумента, ТаблицаДвижений, Сторно = Ложь, Движения)
...
Процедура КорректировкаПоступленияТоваровУслугСформироватьДвиженияНДСПредъявленный(СтруктураШапкиДокумента, ТаблицаПредъявленногоНДС, Сторно = Ложь, Движения)
...
Процедура КорректировкаПоступленияТоваровУслугСформироватьДвиженияКорректировкаНДСПоПартиямЗапасов(СтруктураШапкиДокумента, ТаблицаДвижений, Движения)
...
Функция КорректировкаПоступленияТоваровУслугПолучитьТаблицыДокумента(СтруктураШапкиДокумента)
	...
	|	КорректировкаПоступленияТоваровУслугТовары.Сумма,
	|	КорректировкаПоступленияТоваровУслугТовары.СтавкаНДС,
	|	КорректировкаПоступленияТоваровУслугТовары.СуммаНДС,
	|	КорректировкаПоступленияТоваровУслугТовары.СерияНоменклатуры,
	|	КорректировкаПоступленияТоваровУслугТовары.ХарактеристикаНоменклатуры,
	|	КорректировкаПоступленияТоваровУслугТовары.Склад,
	|	КорректировкаПоступленияТоваровУслугТовары.КоличествоДоИзменения,
	|	КорректировкаПоступленияТоваровУслугТовары.ЦенаДоИзменения,
	|	КорректировкаПоступленияТоваровУслугТовары.СтавкаНДСДоИзменения,
	|	КорректировкаПоступленияТоваровУслугТовары.СуммаДоИзменения,
	|	КорректировкаПоступленияТоваровУслугТовары.СуммаНДСДоИзменения,
	|	КорректировкаПоступленияТоваровУслугТовары.КоличествоДоКорректировки,
	|	КорректировкаПоступленияТоваровУслугТовары.ЦенаДоКорректировки,
	|	КорректировкаПоступленияТоваровУслугТовары.СуммаДоКорректировки,
	|	КорректировкаПоступленияТоваровУслугТовары.СуммаНДСДоКорректировки,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Дата,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Организация,
	|	КорректировкаПоступленияТоваровУслугТовары.Ссылка.Контрагент
	|ИЗ
	...
	|	КорректировкаПоступленияТоваровУслугУслуги.НомерСтроки,
	|	КорректировкаПоступленияТоваровУслугУслуги.Номенклатура,
	|	КорректировкаПоступленияТоваровУслугУслуги.Количество,
	|	КорректировкаПоступленияТоваровУслугУслуги.Цена,
	|	КорректировкаПоступленияТоваровУслугУслуги.Сумма,
	|	КорректировкаПоступленияТоваровУслугУслуги.СтавкаНДС,
	|	КорректировкаПоступленияТоваровУслугУслуги.СуммаНДС,
	|	КорректировкаПоступленияТоваровУслугУслуги.КоличествоДоИзменения,
	|	КорректировкаПоступленияТоваровУслугУслуги.ЦенаДоИзменения,
	|	КорректировкаПоступленияТоваровУслугУслуги.СтавкаНДСДоИзменения,
	|	КорректировкаПоступленияТоваровУслугУслуги.СуммаНДСДоИзменения,
	|	КорректировкаПоступленияТоваровУслугУслуги.СуммаДоИзменения,
	|	КорректировкаПоступленияТоваровУслугУслуги.КоличествоДоКорректировки,
	|	КорректировкаПоступленияТоваровУслугУслуги.ЦенаДоКорректировки,
	|	КорректировкаПоступленияТоваровУслугУслуги.СуммаДоКорректировки,
	|	КорректировкаПоступленияТоваровУслугУслуги.СуммаНДСДоКорректировки,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка,
	|	КорректировкаПоступленияТоваровУслугУслуги.СтатьяЗатрат,
	|	КорректировкаПоступленияТоваровУслугУслуги.НоменклатурнаяГруппа,
	|	КорректировкаПоступленияТоваровУслугУслуги.Подразделение,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка.Дата,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка.Организация,
	|	КорректировкаПоступленияТоваровУслугУслуги.Ссылка.Контрагент
	|ИЗ
...
Процедура ПровестиКорректировкуПоступленияПоРегистрамНДС(СтруктураШапкиДокумента, ДокументСсылка) Экспорт
	...
	СтруктураТаблицСторноНДС = КорректировкаПоступленияТоваровУслугПодготовитьСтруктуруТаблицСторнирующихНДСЗаписей(СтруктураШапкиДокумента);
	СтруктураТаблицДокумента = КорректировкаПоступленияТоваровУслугПолучитьТаблицыДокумента(СтруктураШапкиДокумента);
	ЕстьКосвенныеРасходы = КорректировкаПоступленияТоваровУслугПроверитьНаличиеКосвенныхРасходов(СтруктураШапкиДокумента);
	
	Если СтруктураШапкиДокумента.УчитыватьНДС Тогда	
		КорректировкаПоступленияТоваровУслугДвиженияПоРегистрамНДС(СтруктураШапкиДокумента, СтруктураТаблицСторноНДС, СтруктураТаблицДокумента, ЕстьКосвенныеРасходы, Движения);	
	КонецЕсли;
