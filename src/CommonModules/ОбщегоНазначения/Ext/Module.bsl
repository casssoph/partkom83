...
Функция ПолучитьТТПополнениеСкладаФрагмент(Знач вхСсылкаНаДокумент)
	
	Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(вхСсылкаНаДокумент, "Склад, Склад.НеИмеетСобственногоСтока");
	Если Реквизиты.СкладНеИмеетСобственногоСтока Тогда 
		Склад = Константы.СкладОсновной.Получить(); 	
	Иначе
