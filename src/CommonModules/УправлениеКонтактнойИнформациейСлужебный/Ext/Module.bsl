...
Функция СведенияОбАдресеВВидеСтруктуры(Адрес, ДополнительныеПараметры) Экспорт
	...
	Если НЕ Формат9Запятых Тогда
		...
		// ИЛИ НЕ ЭтоРоссийскийАдрес(XDTOАдрес)
		...
		Если ТипЗнч(АдресРФ) = Тип("Строка") Тогда
			...
			КонецЕсли;
		Иначе
			ЭлементыАдреса.Вставить("Страна", Страна.Наименование);
	...
	ЭтоРоссийскийАдрес = ?(ВРег(Результат.Страна) = ВРег(Справочники.СтраныМира.Россия.Наименование), Истина, Ложь);
	...
	Если ПолноеНаименованиеСокращений  = Истина Тогда
		//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
			//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
			АдресныйКлассификаторСлужебный.ПолныеНаименованияСокращений(СоответствиеСокращений);
		//КонецЕсли;
	КонецЕсли;
...
Процедура ЗаполнитьКодыАдреса(Адрес)
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
		//АдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		АдресныйКлассификаторСлужебный.ЗаполнитьКодыАдреса(Адрес);
	//КонецЕсли;
...
Процедура ПодготовкаЭталонаРазделенныхСтранМира() Экспорт
	...
	Если Не ОбщегоНазначения.ПодсистемаСуществует("РаботаВМоделиСервиса") Тогда
		Возврат;
	КонецЕсли;
...
Функция ВсеРегионы() Экспорт
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
	//	МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		Возврат АдресныйКлассификаторСлужебный.СведенияОЗагрузкеСубъектовРФ();
	//КонецЕсли;
	//Возврат Неопределено;
...
Функция РегионКода(Знач Код)
	...
	//	МодульАдресныйКлассификатор = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификатор");
		Возврат АдресныйКлассификатор.НаименованиеРегионаПоКоду(Код);
	//КонецЕсли;
...
Функция КодРегиона(Знач ПолноеНаименование)
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
		//МодульАдресныйКлассификатор = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификатор");
		Код = АдресныйКлассификатор.КодРегионаПоНаименованию(ПолноеНаименование);
...
Функция НаселенныеПунктыПоПредставлению(Знач Текст, Знач СкрыватьНеактуальныеАдреса = Ложь, Знач ВыбиратьСтрок = 50, Знач УточняющаяУлица = "") Экспорт
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
		...
		//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		АдресПоУровням = АдресныйКлассификаторСлужебный.УстановитьСоответствиеЧастейАдресаИхУровнюДляНаселенногоПункта(ДанныеАнализа, УровниАдресныхОбъектов("НаселенныйПункт"));
...
Функция УлицыПоПредставлению(ИдентификаторНаселенногоПункта, Текст, СкрыватьНеактуальныеАдреса = Ложь, ВыбиратьСтрок = 50) Экспорт
	...
	Если ЗначениеЗаполнено(ИдентификаторНаселенногоПункта) Тогда
		//И ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
			...
			//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
			АдресныйКлассификаторСлужебный.УстановитьУровниУлицыПоЧастямАдреса(ИдентификаторНаселенногоПункта, ЧастиАдреса);
			Возврат ЧастиАдреса;
	КонецЕсли;
...
Функция ИдентификаторНаселенногоПунктаПоЧастямАдреса(ЧастиАдреса) Экспорт
	...
	//Если Не ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
	//	Возврат Неопределено;
	//КонецЕсли;
	...
	//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
	СтруктураДанных = АдресныйКлассификаторСлужебный.РезультатПроверкиАдресовПоКлассификатору(Варианты);
...
Функция СписокРеквизитовНаселенныйПункт(Идентификатор = Неопределено, ВариантКлассификатора = "КЛАДР") Экспорт
	...
	//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
	СтруктураДанных = АдресныйКлассификаторСлужебный.АктуальныеАдресныеСведения(Идентификатор);
...
Процедура УстановитьНаселенныйПунктАдресаПоИдентификатору(XDTOАдрес, Идентификатор) Экспорт
	...
	//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
	ДанныеАдреса = АдресныйКлассификаторСлужебный.АктуальныеАдресныеСведения(Идентификатор);
...
Процедура УстановитьУлицуАдресаПоИдентификатору(XDTOАдрес, Идентификатор) Экспорт
	...
	//дресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
	ДанныеАдреса = АдресныйКлассификаторСлужебный.АктуальныеАдресныеСведения(Идентификатор);
	Если ДанныеАдреса.Отказ Тогда
		// Классификатор поломан
		Возврат;
...
Процедура ЗаполнитьИдентификаторыНаселенногоПункта(НаселенныйПунктДетально, ИдентификаторНаселенногоПункта = Неопределено) Экспорт
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
	//	МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		АдресныйКлассификаторСлужебный.УстановитьИдентификаторыНаселенногоПункта(НаселенныйПунктДетально, ИдентификаторНаселенногоПункта);
	//КонецЕсли;
...
Функция КлассификаторДоступенЧерезВебСервис() Экспорт
	...
	Источник = АдресныйКлассификаторСлужебный.ИсточникДанныхАдресногоКлассификатора();
...
Функция ВерсияПоставщикаДанныхКлассификатора()
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
		//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		Возврат АдресныйКлассификаторСлужебный.ВерсияПоставщикаДанных();
	//КонецЕсли;
...
Функция АдресаКлассификатораПоПочтовомуИндексу(Знач Индекс, Знач ДополнительныеПараметры) Экспорт
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
		...
		//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		Возврат АдресныйКлассификаторСлужебный.АдресаПоПочтовомуИндексуКлассификатора(ИндексЧислом, ДополнительныеПараметры);
...
Функция АдресаДляИнтерактивногоВыбора(Родитель, Уровень, ДополнительныеПараметры) Экспорт
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
	//	МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		Возврат АдресныйКлассификаторСлужебный.АдресаДляИнтерактивногоВыбора(Родитель, Уровень, ДополнительныеПараметры);
	//КонецЕсли;
...
Функция СписокАвтоподбораЧастиАдреса(Текст, ИмяЧастиАдреса, ЧастиАдреса, ДополнительныеПараметры) Экспорт
	...
	//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
	Результат = АдресныйКлассификаторСлужебный.ВариантыАвтоподбора(Текст, Родитель, Уровни, ДополнительныеПараметры);
...
Функция СписокАвтоподбораУлицы(НаселенныйПункт, Текст, ДополнительныеПараметры) Экспорт
	...
	//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
	Результат = АдресныйКлассификаторСлужебный.ВариантыАвтоподбора(Текст, НаселенныйПункт, Уровни, ДополнительныеПараметры);
...
Функция СписокДомов(ИдентификаторАдресногоОбъекта, СтрокаПоиска = "") Экспорт
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
	//	МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		СписокДомов = АдресныйКлассификаторСлужебный.СписокДомов(ИдентификаторАдресногоОбъекта, СтрокаПоиска);
		Возврат СписокДомов;
	//КонецЕсли;
...
Функция СформироватьАдресПоПредставлению(Представление)
	...
	Если Адрес.Страна = НаименованиеРоссии Тогда
		//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
			...
			АдресРФ = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип(ПространствоИмен, "АдресРФ"));
			//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
			АдресПоУровням = АдресныйКлассификаторСлужебный.УстановитьСоответствиеЧастейАдресаИхУровню(ДанныеАнализа, УровниАдресныхОбъектов());
			Если АдресПоУровням <> Неопределено Тогда
				ПоместитьАдресВXDTO(АдресРФ, АдресПоУровням);
			КонецЕсли;
...
Функция ОпределитьПочтовыйИндексИОКТМОАдреса(XDTOАдрес, Идентификатор = Неопределено) Экспорт
	...
	//Если ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
		...
		//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
		ИндексИОКМТО = АдресныйКлассификаторСлужебный.ИндексИОКТМОАдресаПоЧастямАдреса(XDTOАдресРФ, Идентификатор);
	//КонецЕсли;
...
Функция ОшибкиЗаполненияАдресаXDTO(XDTOАдрес, ВидИнформации, РезультатГруппами = Ложь) Экспорт
	...
	//Если ПроверятьКлассификатор И ОбщегоНазначения.ПодсистемаСуществует("АдресныйКлассификатор") Тогда
...
Процедура ЗаполнитьОшибкиАдресаПоКлассификатору(XDTOАдресРФ, ФлагиПроверки, Результат)
	...
	//МодульАдресныйКлассификаторСлужебный = ОбщегоНазначения.ОбщийМодуль("АдресныйКлассификаторСлужебный");
	РезультатыАнализа = АдресныйКлассификаторСлужебный.РезультатПроверкиАдресовПоКлассификатору(Адреса);
