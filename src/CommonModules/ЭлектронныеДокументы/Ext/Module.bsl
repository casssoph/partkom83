...
Процедура ЗарегистрироватьДляОтправкиПочты(ОбъектРегистрации, РучнаяРегистрация = Ложь, ОтправитьЗагрузку = Неопределено) Экспорт 
	...
	ИначеЕсли ТипЗнч(ОбъектРегистрации) = Тип("ДокументСсылка.ПоступлениеТоваровУслуг") 
		И ОбщегоНазначения.ПолучитьЗначениеРеквизита(ОбъектРегистрации, "ВидОперацииПоступления") = Перечисления.ВидыПоступленияТоваров.ОтветХранение Тогда
		Возврат;
