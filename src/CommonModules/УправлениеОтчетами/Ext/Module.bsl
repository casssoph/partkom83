...
//  Нет.
//
Процедура ОтправитьДокументПоЭлектроннойПочте(Документ, ИмяФайлаВложения = "", ОбъектПечати = Неопределено, ШаблонПисьма = Неопределено) Экспорт
	...
	ФормаОтправкиДокумента.ШаблонПисьма     = ШаблонПисьма;
