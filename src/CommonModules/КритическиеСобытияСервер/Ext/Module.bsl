...
Процедура ЗарегистрироватьКритическоеСобытие(Знач ОбъектСобытия,знач Событие,ОписаниеОшибки,СтруктураПараметровВызова = неопределено,Оповестить = ложь, ДополнительноеОписаниеОшибки = "") Экспорт 
