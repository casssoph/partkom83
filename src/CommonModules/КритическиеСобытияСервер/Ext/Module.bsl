...
Процедура ЗарегистрироватьКритическоеСобытие(Знач ОбъектСобытия,знач Событие,ОписаниеОшибки,СтруктураПараметровВызова = неопределено,Оповестить = ложь) Экспорт 
	...
	КритическоеСобытиеЗапись.ФлагОтправкиОпопвещения =  КритическиеСобытияПовтИсп.НеобходимоОпопвещение(Событие,Оповестить);	
