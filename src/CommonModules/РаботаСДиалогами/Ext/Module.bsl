	...
	Если ОбщегоНазначения.ЭтоДокумент(Объект.Метаданные()) Тогда
		...
		Если КоманднаяПанель <> Неопределено Тогда
			...
			Если КнопкаКоманднойПанели <> Неопределено Тогда
				...
				КнопкаКоманднойПанели.Кнопки.Добавить("ДействияФормыПоказатьGUID", ТипКнопкиКоманднойПанели.Действие, "Показать GUID", Новый Действие("ДействияФормыПоказатьGUIDНажатие"));
				КнопкаКоманднойПанели.Кнопки.Добавить("ДействияФормыИсторияИзменений", ТипКнопкиКоманднойПанели.Действие, "История изменений", Новый Действие("ДействияФормыИсторияИзменений"));
				КнопкаИсторияОбмена = КнопкаКоманднойПанели.Кнопки.Добавить("ИсторияОбменаССайтом",ТипКнопкиКоманднойПанели.Действие,"История обмена", Новый Действие("ДействиеФормыНажатиеКнопки"));		
