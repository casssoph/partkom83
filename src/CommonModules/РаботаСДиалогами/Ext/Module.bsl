...
Процедура ДобавитьКнопкуРедактированияОбщедоступныхРеквизитов(Объект,Форма)
	...
	//
	//ИмяПВХ = СтрЗаменить(ИмяМетаданных,".","_");
	//
	//Если не МассивЭлементов.Найти(ИмяПВХ) = Неопределено тогда 
	//	
	//	ПВХ  =  ПредопределенноеЗначение("ПланВидовХарактеристик.ОбщедоступныеРеквизиты."+ИмяПВХ);
	//	Если не ПВХ.Пользователи.Найти(ПараметрыСеанса.ТекущийПользователь,"Пользователь") = Неопределено тогда 
...
Функция ДляПользователяДоступноРедактированиеРеквизитов(Пользователь,ИмяМетаданных)
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	ОбщедоступныеРеквизитыПользователи.Пользователь = &Пользователь
...
Процедура ОбработатьНажатиеКнопкиФормы(Кнопка,Объект,Форма)  Экспорт
	...
	ИначеЕсли Кнопка.Имя = "РедактированиеОбщедоступныхРеквизитов" тогда 
		...
		Форма.Закрыть();
		Описание  = новый ОписаниеОповещения("РедактированиеОбщедоступныхРеквизитов_Завершение",РаботаСДиалогами,Объект);
...
Процедура РедактированиеОбщедоступныхРеквизитов_Завершение(Результат,Объект)   Экспорт 
