...
Процедура ДобавитьПрограммныеКнопки(Объект, Форма, ИмяКоманднойПанели = "ДействияФормы", ИмяКнопки = "Действия") Экспорт
	...
	Если КоманднаяПанель <> Неопределено Тогда
		...
		Если КнопкаКоманднойПанели <> Неопределено Тогда
			...
			КнопкаКоманднойПанели.Кнопки.Добавить("ИсторияОбменаССайтом",ТипКнопкиКоманднойПанели.Действие,"История обмена с сайтом", Новый Действие("ДействиеФормыНажатиеКнопки"));		
		КонецЕсли;
	КонецЕсли;
	
	//Форма.ЭлементыФормы.ДействияФормы.Кнопки.Действия.Кнопки.Добавить(, ТипКнопкиКоманднойПанели.Разделитель);
	//Форма.ЭлементыФормы.ДействияФормы.Кнопки.Действия.Кнопки.Добавить("ДействияФормыПоказатьGUID", ТипКнопкиКоманднойПанели.Действие, "Показать GUID", Новый Действие("ДействияФормыПоказатьGUIDНажатие"));
	//Форма.ЭлементыФормы.ДействияФормы.Кнопки.Действия.Кнопки.Добавить("ДействияФормыИсторияИзменений", ТипКнопкиКоманднойПанели.Действие, "История изменений", Новый Действие("ДействияФормыИсторияИзменений"));
	//Форма.ЭлементыФормы.ДействияФормы.Кнопки.Действия.Кнопки.Добавить("ИсторияОбменаССайтом",ТипКнопкиКоманднойПанели.Действие,"История обмена с сайтом", Новый Действие("ДействиеФормыНажатиеКнопки"));		
