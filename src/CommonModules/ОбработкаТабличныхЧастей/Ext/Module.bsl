...
Функция СуммаБезСкидкиСтрокиТабличнойЧасти(ТекущаяСтрока, ОтказыПоТекущемуДокументу) Экспорт
...
Функция СуммаСкидкиСтрокиТабличнойЧасти(ТекущаяСтрока, ОтказыПоТекущемуДокументу) Экспорт
