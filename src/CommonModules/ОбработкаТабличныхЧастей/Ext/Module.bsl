...
Процедура ПересчитатьЦенуПоставщикуСтрокиТабличнойЧасти(ТекущаяСтрока, СтруктураДействий, КэшированныеЗначения)
	...
	Если СтруктураДействий.Свойство("ПересчитатьЦенуПоставщикуПослеУценки") Тогда
		ТекущаяСтрока.ЦенаПоставщикуПослеУценки = ТекущаяСтрока.СебестоимостьЦена - ТекущаяСтрока.СуммаУценкиПоставщику;
