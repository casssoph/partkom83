...
Процедура ПоказатьВводШтрихкода(ОповещениеУспешногоВвода, Количество = Неопределено, Заголовок = "") Экспорт 
	...
	//Некорректно работает в случае обычного приложения, только в управляемом!
	//В режиме обычного активность перескакивает с поля ввода значения на родительскую форму
