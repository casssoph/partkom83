...
//Рудаков возврат истина/ложь доп.права на просмотр цен
Функция РазрешитьПросмотрЦенВДокументах() Экспорт

	СписокФильтров = УправлениеПользователями.ПолучитьЗначениеПраваДляТекущегоПользователя(ПланыВидовХарактеристик.ПраваПользователей.ПросмотрЦенВДокументах, Ложь);
...
Функция РазрешеноПревышениеОстаткаТоваровОрганизации(Организация = Неопределено) Экспорт
	...
	Возврат Истина;  // Добавлено 10.02.2017
...
Функция ДоступностьКнопкиПерепровести() Экспорт 
	
	лКлючАлгоритма = "ОбщийМодуль_УправлениеДопПравамиПользователей_ДоступностьКнопкиПерепровести";
	...
	СписокПрав = УправлениеПользователями.ПолучитьЗначениеПраваДляТекущегоПользователя(
		ПланыВидовХарактеристик.ПраваПользователей.ДоступностьКнопкиПерепровести,
		Ложь);
...
Функция РазрешитьРедактированиеЦенВДокументахСУстановленнымиСкидкамиНаСайте() Экспорт

	СписокФильтров = УправлениеПользователями.ПолучитьЗначениеПраваДляТекущегоПользователя(ПланыВидовХарактеристик.ПраваПользователей.РедактированиеЦенВДокументахСУстановленнымиСкидкамиНаСайте, Ложь);
