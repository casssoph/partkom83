...
Функция СнятьБлокировкуКонтрагентаВ1С(КонтрагентыДляРазблокировки, ДокументОплаты, ТекстПисьма)
	...
	Для Каждого Контрагент Из КонтрагентыДляРазблокировки Цикл
		...
		Попытка
			Текст =		"Была снята блокировка с контрагента " + Контрагент.Наименование + "<" + Контрагент.Код + ">" +
						" в связи с поступлением оплаты: " + ДокументОплаты + Символы.ПС +
						"Старые значения блокировок: " +
						?(ЗначениеЗаполнено(Контрагент.Блокировка_Отгрузок_Дата), ">Блокировка отгрузок: " + Формат(Контрагент.Блокировка_Отгрузок_Дата, "ДФ=dd.MM.yyyy") + "(" + СокрЛП(Контрагент.Блокировка_Отгрузок_Коммент) + ")", "") + 
						?(ЗначениеЗаполнено(Контрагент.Блокировка_Заказов_Дата), ">Блокировка заказов: " + Формат(Контрагент.Блокировка_Заказов_Дата, "ДФ=dd.MM.yyyy") + "(" + СокрЛП(Контрагент.Блокировка_Заказов_Коммент) + ")", "");
