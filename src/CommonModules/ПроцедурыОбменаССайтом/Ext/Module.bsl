...
Процедура ОтложенноеСнятиеБлокировкиКонтрагентов(ДокументОплаты) Экспорт
...
Процедура СнятьБлокировкуКонтрагентаВ1С(КонтрагентыДляРазблокировки, ДокументОплаты, ТекстПисьма)
