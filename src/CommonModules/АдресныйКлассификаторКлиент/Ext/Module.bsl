...
Процедура ЗагрузитьАдресныйКлассификатор(Параметры = Неопределено) Экспорт
	...
	//Иначе
		...
		ИмяФормы = "Обработка.ЗагрузкаАдресногоКлассификатора.Форма.Форма";
	//КонецЕсли;
...
Процедура ОчиститьАдресныйКлассификатор(Параметры = Неопределено) Экспорт
	...
	ИмяФормы = "РегистрСведений.АдресныеОбъекты.Форма.ОчисткаАдресногоКлассификатора";
