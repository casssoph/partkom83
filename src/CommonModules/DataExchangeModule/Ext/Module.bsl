...
Функция ПроверитьДокументыДляОбменаТоплог(ТекстЗапроса) Экспорт
	...
	Для каждого Строка из Строки  Цикл
		...
		Если Результат.Пустой()  Тогда
			//Документ не найден
			СообщениеДиагностики = "Документ в базе не найден";
			Найдено = "Не найдено";
			Продолжить;	
		Иначе	
			//Документ найден
			...
			Если СсылкаНаДокумент.Проведен = ЛОЖЬ Тогда
				СообщениеДиагностики = "Документ не проведен";
				Найдено = "Не найдено";	
			КонецЕсли;	
			...
			Если ЦелевойСтатус <> СсылкаНаДокумент.СтатусДокумента  Тогда
				//Статус не совпадает
				СообщениеДиагностики = "Документ проведен; но имеет статус " + СсылкаНаДокумент.СтатусДокумента + " вместо " + ЦелевойСтатус;
				Найдено = "Не найдено";  
			Иначе
				//Статус совпадает
