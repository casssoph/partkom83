...
Функция ПроверитьДокументыДляОбменаТоплог(ТекстЗапроса) Экспорт
	...
	//			КонецЕсли;
	//			
	//			Если СуммаПриПервойПечати <> "" + ВыборкаСчетФактура.Сумма Тогда
	//				
	//				СообщениеДиагностики = СообщениеДиагностики + "Не совпадает сумма документа." + " В ВМС: " + СуммаПриПервойПечати + " , в 1с: " +  ВыборкаСчетФактура.Сумма + Символы.ПС ;
	//				Ошибка = "Да";
	//				
	//			КонецЕсли;
	//			
