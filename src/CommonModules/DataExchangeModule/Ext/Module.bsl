	...
	Для каждого Строка из Строки  Цикл
		...
		Иначе	
			...
			Иначе
				...
				Если ДатаПервойПечати <> "" + ВыборкаСчетФактура.ДатаПервойПечати Тогда
					
					СообщениеДиагностики = СообщениеДиагностики + "Не совпадает дата первой печати." + " В ВМС: " + ДатаПервойПечати + " , в 1с: " +  ВыборкаСчетФактура.ДатаПервойПечати + Символы.ПС ;
					Ошибка = "Да";
