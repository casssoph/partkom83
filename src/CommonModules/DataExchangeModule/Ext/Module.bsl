...
Функция RegisterToExchange(ObjectType, ObjectKey) Экспорт
	...
	Если ObjectType = "Справочники.ПрайсыПоставщиков" Тогда
		ОбъектЗарегистрирован = ЗарегистрироватьПрайсыПоставщика(ObjectKey);
	КонецЕсли;
	Возврат ОбъектЗарегистрирован;
	
КонецФункции

Функция ЗарегистрироватьПрайсыПоставщика(ObjectKey)
	
	Массив = МассивОбъектов(Справочники.ПрайсыПоставщиков, ObjectKey);
...
Функция МассивОбъектов(Менеджер, ObjectKey)
	...
	Массив = Новый Массив;
	Для Каждого СтруктураКлюча Из Новый Структура(ObjectKey) Цикл
		Ключ = СтруктураКлюча.Ключ;
