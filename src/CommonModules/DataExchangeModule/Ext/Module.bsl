	...
	Для каждого Строка из Строки  Цикл
		...
		Иначе	
			...
			Иначе
				...
				Если ДатаПервойПечати <> "" + ВыборкаСчетФактура.ДатаВыставления Тогда
					
					СообщениеДиагностики = СообщениеДиагностики + "Не совпадает дата первой печати." + " В ВМС: " + ДатаПервойПечати + " , в 1с: " +  ВыборкаСчетФактура.ДатаВыставления + Символы.ПС ;
					Ошибка = "Да";
