...
Процедура ПеререгистрироватьОбъектыВОбмене(УзелОбмена) Экспорт
	...
	лКлючАлгоритма = "ОбщийМодуль_ОбменДаннымиКлиентСервер_ПеререгистрироватьОбъектыВОбмене";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);		
		Возврат;		
...
Функция СоздатьСтруктуруРегистраСведений(вхРегистр) Экспорт
	...
	лКлючАлгоритма = "ОбщийМодуль_ОбменДаннымиКлиентСервер_СоздатьСтруктуруРегистраСведений";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		АлгоритмыЗначениеВозврата = Неопределено;		
		Выполнить(лЗамена);		
