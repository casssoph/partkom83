...
Функция ПолучитьСтруктуруТаблицыАдресов()
	...
	//ТаблицаДанных.Колонки.Добавить("capital_marker");           // Признак центра района или региона
																  //1 — центр района
	...
	ТаблицаДанных.Колонки.Добавить("fias_code");                // Иерархический код адреса в ФИАС (СС+РРР+ГГГ+ППП+СССС+УУУУ+ДДДД)
	ТаблицаДанных.Колонки.Добавить("kladr_id");                 // Код КЛАДР
	ТаблицаДанных.Колонки.Добавить("okato");                    // Код ОКАТО
	ТаблицаДанных.Колонки.Добавить("oktmo");                    // Код ОКТМО
