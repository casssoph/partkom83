...
&НаСервереБезконтекста
Процедура РезервыПриАктивизацииСтрокиНаСервере()
	
	//УстановитьПараметрЗапросаДвиженияРезервов(СтрокаЗаявки);
...
Процедура РезервыПриАктивизацииСтроки(Элемент)
	...
	//РезервыПриАктивизацииСтрокиНаСервере(Элементы.Резервы.ВыделенныеСтроки[0].СтрокаЗаявки, );
КонецПроцедуры
