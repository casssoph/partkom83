...
Процедура ВыполнитьВыгрузку(Знач ИмяФайла, ТолькоПроверкаНедопустимыхСимволов = Ложь) Экспорт
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ВыполнитьВыгрузку";
...
Процедура ВыполнитьЗагрузку(Знач ИмяФайла) Экспорт
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ВыполнитьЗагрузку";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура Инициализация() Экспорт
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_Инициализация";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ВыполнитьПроверкуДляВыгрузкиОбъектовИзПланаОбмена(СсылкаНаУзел) Экспорт
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ВыполнитьПроверкуДляВыгрузкиОбъектовИзПланаОбмена";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ВыгрузитьДанныеМассиваСсылок(МассивСсылок, СтрокаИмяДляЗапроса, ЗаписьXML, ТолькоПроверкаНедопустимыхСимволов = Ложь, ОбъектыВыгруженныеСОшибками = Неопределено)
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ВыгрузитьДанныеМассиваСсылок";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ВыгрузкаДанных(ЗаписьXML, ТолькоПроверкаНедопустимыхСимволов = Ложь, ОбъектыВыгруженныеСОшибками = Неопределено)
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ВыгрузкаДанных";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ЗаписьДанныхОбъектногоТипа(СтрокаДереваМетаданных, ЗаписьXML, ОбъектыВыгруженныеСОшибками, ТолькоПроверкаНедопустимыхСимволов = Ложь)
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ЗаписьДанныхОбъектногоТипа";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ЗапросИЗапись(РезультатЗапроса, ЗаписьXML, ЗапросВерхнегоУровня = Ложь, 
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ЗапросИЗапись";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ОбработкаРезультатаЗапроса(РезультатЗапроса, ЗаписьXML, ЭтоЗапросПоОбъекту = Ложь, 
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ОбработкаРезультатаЗапроса";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ВыгрузитьПодчиненныеЗначенияНабора(ЗаписьXML, Движение, МассивКолонок, ОбъектыВыгруженныеСОшибками, ТолькоПроверкаНедопустимыхСимволов)
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ВыгрузитьПодчиненныеЗначенияНабора";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ЗаписатьЗначениеПриНеобходимости(АнализируемоеЗначение, ЗаписьXML, 
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ЗаписатьЗначениеПриНеобходимости";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ЗаписьКонстанты(ЗаписьXML, МД_Константа, ОбъектыВыгруженныеСОшибками, ТолькоПроверкаНедопустимыхСимволов)
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ЗаписьКонстанты";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ЗаписьРегистра(ЗаписьXML, СтрокаДереваМетаданных, ОбъектыВыгруженныеСОшибками, ТолькоПроверкаНедопустимыхСимволов, РегистрБухгалтерии = Ложь)
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ЗаписьРегистра";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
...
Процедура ЗаписьЧерезНаборЗаписей(ЗаписьXML, МенеджерНабораЗаписей, ДляЗапроса, ИмяОбъекта, 
	...
	лКлючАлгоритма = "Обработка_ВыгрузкаЗагрузкаДанныхXML_МодульОбъекта_ЗаписьЧерезНаборЗаписей";
	лЗамена =  АлгоритмыПолучитьЗамену(лКлючАлгоритма);
	Если Не лЗамена = Неопределено Тогда
		Выполнить(лЗамена);
		Возврат;
