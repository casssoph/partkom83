...
мПрефиксВесовогоТовара      = "";
мДлинаКодаВесовогоТовара    = 11;
...
мХарактеристикиПустаяСсылка = Неопределено;//Справочники.ХарактеристикиНоменклатуры.ПустаяСсылка();
мСерииПустаяСсылка          = Неопределено;
мМагнитнаяКарта             = Неопределено;//Перечисления.ВидыИнформационныхКарт.Магнитная;
...
мОшибкаНеизвестныйТовар     = Неопределено;//Перечисления.ТООшибкиТСД.ОшибкаНеизвестныйТовар;
мОшибкаЗагрузкиОтчета       = Неопределено;//Перечисления.ТООшибкиККМOffline.ОшибкаЗагрузкиОтчета;
мОшибкаНеизвестнаяКарта     = Неопределено;//Перечисления.ТООшибкиСМК.ОшибкаНеизвестнаяКарта;
