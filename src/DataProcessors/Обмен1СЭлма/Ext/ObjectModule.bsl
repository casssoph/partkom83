...
Процедура УстановитьДанныеКонтрагента(Структура, ОбъектXDTO)
	...
	ЗначениеКоэффициента = CRM.Company.DelayOfPayment;
	ЗначениеКоэффициента =  ?(ЗначениеЗаполнено(ЗначениеКоэффициента), ЗначениеКоэффициента, 1);
	Структура.Вставить("КоэффициентСуммыКредита", ?(ЗначениеКоэффициента > 10, 3, ЗначениеКоэффициента));
