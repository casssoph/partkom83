...
Процедура КонтрольДанныхКонтрагента(ДанныеКонтрагента)
	Если ТекущаяДата() < '20190101000000' И Справочники.УчетныеЗаписиСайта.ПроверитьЛогинКонтрагентаВБазеСПб(ДанныеКонтрагента.Логин) Тогда
		ДанныеКонтрагента.Ошибка = Истина;
		ДополнитьОшибку(ДанныеКонтрагента.ТекстОшибки, "Контрагент с логином <" + ДанныеКонтрагента.Логин + "> уже существует в базе СПб");
		Возврат;
	КонецЕсли;
