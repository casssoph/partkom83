	...
	Иначе
		...
		Иначе
			Если ВыбранныйКонтрагент.ЮрФизЛицо = Перечисления.ЮрФизЛицо.ФизЛицо Тогда
				СтруктураДанных.Отказ = Истина;
				ДополнитьОшибку(СтруктураДанных.ТекстОшибки, "Контрагент является физ. лицом: <" + СтруктураДанных.КодКонтрагента + ">");
			ИначеЕсли ВыбранныйКонтрагент.СайтГруппаКонтрагентаЗаблокировано Тогда
				СтруктураДанных.Отказ = Истина;
				ДополнитьОшибку(СтруктураДанных.ТекстОшибки, "У контрагента заблокирована ценовая группа: <" + СтруктураДанных.КодКонтрагента + ">");
			...
			Иначе
				ДополнитьОшибку(СтруктураДанных.ТекстОшибки, "Контрагент уже имеет указанную ценовую группу: <" + СтруктураДанных.КодКонтрагента + ">");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
