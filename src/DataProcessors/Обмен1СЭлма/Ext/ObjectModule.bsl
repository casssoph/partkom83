...
Процедура УстановитьДанныеКонтрагента(Структура, ОбъектXDTO)
	...
	Структура.Вставить("ДопустимоеЧислоДнейЗадолженности", Константы.ЛимитыСуммыЗадолженностиЮрЛицо.Получить());
	Структура.Вставить("КоэффициентСуммыКредита", ?(CRM.Company.DelayOfPayment = 0, 1, CRM.Company.DelayOfPayment));
