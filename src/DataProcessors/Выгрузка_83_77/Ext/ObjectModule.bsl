...
Процедура ОбойтиДокументыРекурсией(пар_Массив)
	...
	Для каждого лДок из пар_Массив цикл 
		...
		ИначеЕсли лстр.типвид = "Документ.ПеремещениеТоваров" тогда	
			...
			мОснования3 = ПолучитьТчДок(лстр.сцылка,"Товары","СтрокаЗаявки.Поступление","ПеремещениеТоваров");
...
Функция ОбработатьКвитанцию(пар_ПолноеИмяФайла, пар_ИмяФайла)
	...
	Возврат Рез;
КонецФункции
Процедура НайтиИуничтожитьПродублированныеФайлыВыгрузки(пар_ИмяФайла,пар_ВерсияДанных)
