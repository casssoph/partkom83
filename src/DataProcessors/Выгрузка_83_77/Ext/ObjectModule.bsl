...
КонецПроцедуры
Функция ВыгрузитьДанныеПоЖеланию(пар_МассивСсылокРазличныхВидов, пар_ОпроситьСсылкиИзТЧ = Истина) экспорт
	...
	//   |ИЗ
	//   |	Документ.КорректировкаЗаказаПоставщику КАК ЗаказПоставщику
	//   |УПОРЯДОЧИТЬ ПО
