Процедура ВыполнитьРегламентноеЗадание() Экспорт
	...
	Пока Выборка.Следующий() Цикл 
		...
		ИначеЕсли ТипЗнч(Выборка.СсылкаНаДокумент) = Тип("ДокументСсылка.ПеремещениеТоваров") Тогда 
			Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Выборка.СсылкаНаДокумент, "ПометкаУдаления,Проведен,СтатусДокумента,ДокументОснование, ДокументОснование.СтатусДокумента, ДокументОснование.ОбновленИзТопЛог, ДокументОснование.Дата, ДокументОснование.Склад.СкладПриемки, ДокументОснование.ДокументОснование");
			
			//<< 25.07.2019 Горохов П.Е. ХХ-2884
			УсловиеПоступлениеДоп = Истина;
			Если ТипЗнч(Реквизиты.ДокументОснование) = Тип("ДокументСсылка.ПоступлениеТоваровУслуг") Тогда
				СозданНаОснованииМХ3 = Ложь;
				УсловиеПоступлениеДоп = ПроведениеДокументовКлиентСервер.УсловиеПроведенияРазмещенияПТУНаОснованииВозвратаМХ3(Реквизиты.ДокументОснование, СозданНаОснованииМХ3, Реквизиты.ДокументОснованиеДокументОснование);
			КонецЕсли;
			//>> 25.07.2019 Горохов П.Е. ХХ-2884
			
			УсловиеПоступление = ТипЗнч(Реквизиты.ДокументОснование) = Тип("ДокументСсылка.ПоступлениеТоваровУслуг") 
			И (Реквизиты.ДокументОснованиеСтатусДокумента = Справочники.СтатусыДокументов.ПоступлениеТоваровПринят 
				Или Реквизиты.ДокументОснованиеСтатусДокумента = Справочники.СтатусыДокументов.ПоступлениеТоваровРазмещен)
			И УсловиеПоступлениеДоп;
