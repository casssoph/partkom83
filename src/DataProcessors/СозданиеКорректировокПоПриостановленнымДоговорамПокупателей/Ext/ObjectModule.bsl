	...
	Пока ВыборкаПоКонтрагентам.Следующий() Цикл 
		...
		Попытка
			Пока ВыборкаСоздатьКорр.Следующий() Цикл 
				...
				Док = СоздатьКорректировкуДолга(ВыборкаПоКонтрагентам.Контрагент, ВыборкаСоздатьКорр.ДоговорКонтрагента, ВыборкаСоздатьКорр.ТекущаяОрганизация, ВыборкаСоздатьКорр.Сумма, ВыборкаСоздатьКорр.СуммаРегл);
...
Функция СоздатьКорректировкуДолга (Контрагент, ДоговорКонтрагента, Организация, Сумма, СуммаРегл)
