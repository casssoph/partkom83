	...
	//Если Не Параметры.НеИскать Тогда 
		Запрос = Новый Запрос;
			Запрос.Текст = "ВЫБРАТЬ
			               ...
			               |	И СлужебноеЗаданиеПокупатели.Реализация.Проведен
			               ...
			               |ГДЕ
			               |	РеализацияТоваровУслуг.Проведен
			               |	И &ДобавлятьРТУГотовКВыдачеВДоставкуВодителем
			               |	И &ТипДоставки = ЗНАЧЕНИЕ(Справочник.ТипыДоставки.ДоставкаВодителем)
			               |	И &ОтборМаршрутДоставкиГруппа
			               |	И (РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки В ИЕРАРХИИ (&МаршрутДоставки)
			               |			ИЛИ РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки2 В ИЕРАРХИИ (&МаршрутДоставки)
			               |			ИЛИ РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки3 В ИЕРАРХИИ (&МаршрутДоставки)
			               |			ИЛИ РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки4 В ИЕРАРХИИ (&МаршрутДоставки)
			               |			ИЛИ РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки5 В ИЕРАРХИИ (&МаршрутДоставки))
			               |	И РеализацияТоваровУслуг.СтатусДокумента = ЗНАЧЕНИЕ(Справочник.СтатусыДокументов.РеализацияТоваровУслугГотовКВыдаче)
			               |	И СлужебноеЗаданиеПокупатели.Ссылка ЕСТЬ NULL
			               |	И РеализацияТоваровУслуг.МаршрутДоставки.Склад.ФизическийСклад = &Склад
			               |	И МегаЛогист_МаршрутноеЗаданиеДокументыРеализации.Ссылка ЕСТЬ NULL
			               ...
			               |	И &ТипДоставки = ЗНАЧЕНИЕ(Справочник.ТипыДоставки.ДоставкаВодителем)
			               |	И &ОтборМаршрутДоставки
			               |	И (РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки = &МаршрутДоставки
			               |			ИЛИ РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки2 = &МаршрутДоставки
			               |			ИЛИ РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки3 = &МаршрутДоставки
			               |			ИЛИ РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки4 = &МаршрутДоставки
			               |			ИЛИ РеализацияТоваровУслуг.Контрагент.ОсновнаяТорговаяТочка.МаршрутДоставки5 = &МаршрутДоставки)
			               |	И РеализацияТоваровУслуг.СтатусДокумента = ЗНАЧЕНИЕ(Справочник.СтатусыДокументов.РеализацияТоваровУслугГотовКВыдаче)
			               |	И СлужебноеЗаданиеПокупатели.Ссылка ЕСТЬ NULL
			               |	И РеализацияТоваровУслуг.МаршрутДоставки.Склад.ФизическийСклад = &Склад
			               |	И МегаЛогист_МаршрутноеЗаданиеДокументыРеализации.Ссылка ЕСТЬ NULL
