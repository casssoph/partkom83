	...
	//Если Не Параметры.Довыписка Тогда 
		Для Каждого СтрокаД Из ЭтотОбъект.ДокументыДобавляемые Цикл 
			...
			Если Не Параметры.Довыписка И СтрокаД.Документ.СтатусДокумента = Справочники.СтатусыДокументов.РеализацияТоваровУслугСборка Или
				Параметры.ТипДоставки = Справочники.ТипыДоставки.ЭкспрессДоставка И СтрокаД.Документ.СтатусДокумента = Справочники.СтатусыДокументов.РеализацияТоваровУслугГотовКВыдаче Тогда 
