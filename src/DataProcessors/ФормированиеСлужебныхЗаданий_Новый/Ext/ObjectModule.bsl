...
Процедура ВыполнитьРегламентноеЗадание() Экспорт 
	...
	Иначе
		...
		ДобавитьВОчередьФормированияСлужебныхЗаданий(ПараметрыФормированияСЗ, НомерПотока);
...
Процедура ДобавитьВОчередьФормированияСлужебныхЗаданий(ПараметрыФормированияСЗ, НомерПотока)
	Запрос = Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ
