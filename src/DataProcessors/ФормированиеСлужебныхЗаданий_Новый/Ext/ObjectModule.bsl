...
Функция ПараметрыФормированияСЗ() 
	...
	Запрос.Текст =  "ВЫБРАТЬ
	                ...
	                |				И (&ДтТек МЕЖДУ ДОБАВИТЬКДАТЕ(ДатыФормированияСлужебныхЗаданий.ДатаОкончания, МИНУТА, -1) И ДОБАВИТЬКДАТЕ(ДатыФормированияСлужебныхЗаданий.ДатаОкончания, МИНУТА, 3))
