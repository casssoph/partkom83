...
Процедура СформироватьСписокПремийНаСервере()
	...
	|	МАКСИМУМ(КорректировкаДолга.Ссылка) КАК КорректировкаСсылка
	...
	|	МАКСИМУМ(ЕСТЬNULL(ВЗ.СуммаОтражено, 0)) КАК СуммаОтражено,
	|	ЛОЖЬ КАК Пометка,
	|	СУММА(ЕСТЬNULL(ВЗ.СуммаОтгрузки, 0)) КАК СуммаОтгрузки,
	|	ВЗ.КорректировкаСсылка КАК КорректировкаСсылка,
	|	ВЫБОР
	...
	|		NULL,
	|		ВТКорректировки.КорректировкаСсылка
	|	ИЗ
...
Процедура СоздатьДокументы(Команда)
	...
	Если ДокументыВыбраны Тогда
		...
		Если ВыгружатьВОПАвтоматически Тогда
