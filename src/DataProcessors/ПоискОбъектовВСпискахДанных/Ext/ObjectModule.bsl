...
Процедура ПроизвестиОтборДанных(ЗначениеОтбора, Знач ПредлагатьСнятьИерархическийПросмотр = Ложь, 
	...
	КонецЕсли;
	Попытка
		Список.Отбор.Артикул.ВидСравнения=ВидСравнения.Равно;
	Исключение
	КонецПопытки;	
	Попытка
		Список.Отбор.ИНН.ВидСравнения=ВидСравнения.Равно;
	Исключение
	КонецПопытки;	
	Попытка
		Список.Отбор.Логин.ВидСравнения=ВидСравнения.Равно;
	Исключение
	КонецПопытки;	
	Попытка
