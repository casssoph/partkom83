...
Процедура ВыполнитьОбработку() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Иначе
			...
			,
			Истина,
			"Период: "+Выборка.Период+", Событие: "+Выборка.Событие+", Параметр: "+Выборка.Параметр,
...
Функция ОбработатьВозвратИзТоплог(Выборка, ТекстОшибки = "")
	...
	Если НЕ ТипЗнч(Выборка.ПараметрСобытия) = Тип("ДокументСсылка.ВозвратТоваровОтПокупателя") Тогда
