...
Процедура УстановитьРеквизитКорректироватьНДСКорректировкаПоступленияТоваровУслуг() Экспорт
	УстановитьРеквизитДокумента("КорректировкаПоступленияТоваровУслуг","КорректироватьНДС",
		Истина,Новый Структура("КорректироватьНДС",Ложь),Истина);
КонецПроцедуры
