...
Процедура ВыполнитьОбновление() Экспорт
	...
	//шаблон для установки запускаемых модулей при обновлении
//	ТекущаяВерсияИБ    = Константы.НомерВерсииКонфигурации.Получить();
//	НоваяВерсияИБ      = "указать номер версии ИБ";

//	Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
		
//			список модулей для обновления
//          складывать в обработку 
//			Обработки.ОбработкаОбновления.Создать().
...
//	КонецЕсли;	
	...
	#Область СтарыйКодОбновленияКонфигурации
 //   ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
 //   НоваяВерсияИБ = "1.0.0.1";
 //   Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
 //   	Обработки.ОбработкаОбновления.Создать().ОбновлениеИнформационнойБазы_1_0_0_1();
 //   	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
 //   КонецЕсли;
 //   
 //   ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
 //   НоваяВерсияИБ = "1.0.0.2";
 //   Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
 //   	Обработки.ОбработкаОбновления.Создать().ОбновлениеИнформационнойБазы_1_0_0_2();
 //   	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
 //   КонецЕсли;
 //   
 //   ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
 //   НоваяВерсияИБ = "1.0.0.3";
 //   Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
 //   	Обработки.ОбработкаОбновления.Создать().ОбновлениеИнформационнойБазы_1_0_0_3();
 //   	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
 //   КонецЕсли;
 //   
 //   ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
 //   НоваяВерсияИБ = "1.0.0.4";
 //   Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
 //   	Обработки.ОбработкаОбновления.Создать().ОбновлениеИнформационнойБазы_1_0_0_2();
 //   	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
 //   КонецЕсли;
 //   
 //   ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
 //   НоваяВерсияИБ = "1.0.0.5";
 //   Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
 //   	Обработки.ОбработкаОбновления.Создать().ОбновлениеИнформационнойБазы_1_0_0_5();
 //   	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
 //   КонецЕсли;
 //   
 //   ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
 //   НоваяВерсияИБ = "1.0.0.6";
 //   Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
 //   	Обработки.ОбработкаОбновления.Создать().ОбновлениеИнформационнойБазы_1_0_0_6();
 //   	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
 //   КонецЕсли;
 //   
 //   ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
 //   НоваяВерсияИБ = "1.0.0.7";
 //   Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
 //   	Обработки.ОбработкаОбновления.Создать().ОбновлениеИнформационнойБазы_1_0_0_7();
 //   	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
 //   КонецЕсли;
 //
 //   ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
 //   НоваяВерсияИБ = "1.0.0.8";
 //   Если ТекущаяВерсияИБ <> НоваяВерсияИБ И НоваяВерсияИБ <= Метаданные.Версия Тогда
 //   	Обработки.ОбработкаОбновления.Создать().ОбновлениеИнформационнойБазы_1_0_0_8();
 //   	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
 //   КонецЕсли;
 	#КонецОбласти
 
	//Процедура обновления конфигурации должна находиться в модуле обработки "_ОбработкаОбновления" и иметь вид ОбновлениеИнформационнойБазы_1_0_0_0()
	СтрокаСМетодамиОбъекта = ОбщегоНазначенияВызовСервера.ПолучитьСтрокуСМетодамиОбъекта("Обработки._ОбработкаОбновления");
	Если СтрокаСМетодамиОбъекта = Неопределено Тогда
		Возврат
	КонецЕсли;
	
	ТаблицаОбновлений = Новый ТаблицаЗначений;
	ТаблицаОбновлений.Колонки.Добавить("НомерВерсии");
	ТаблицаОбновлений.Колонки.Добавить("НомерВерсииРазряд1");
	ТаблицаОбновлений.Колонки.Добавить("НомерВерсииРазряд2");
	ТаблицаОбновлений.Колонки.Добавить("НомерВерсииРазряд3");
	ТаблицаОбновлений.Колонки.Добавить("НомерВерсииРазряд4");
	ТаблицаОбновлений.Колонки.Добавить("ИмяМетода");
	
	ЧтениеСтрокиXML = Новый ЧтениеXML;
	ЧтениеСтрокиXML.УстановитьСтроку(СтрокаСМетодамиОбъекта);
	Пока ЧтениеСтрокиXML.Прочитать() Цикл
		Если ЧтениеСтрокиXML.ТипУзла = ТипУзлаXML.КонецЭлемента Тогда
			Продолжить;
		КонецЕсли;
		Если ЧтениеСтрокиXML.Имя = "Method" Тогда
			Пока ЧтениеСтрокиXML.ПрочитатьАтрибут() Цикл
				Если ЧтениеСтрокиXML.Имя = "Name" И Сред(ЧтениеСтрокиXML.Значение, 1, 28) = "ОбновлениеИнформационнойБазы" Тогда
					НоваяСтрока = ТаблицаОбновлений.Добавить();
					НоваяСтрока.НомерВерсии = СтрЗаменить(Сред(ЧтениеСтрокиXML.Значение, 30), "_",".");
					СимволРазделитель = ".";
					МногоСтрока = СтрЗаменить(НоваяСтрока.НомерВерсии, СимволРазделитель, Символы.ПС);
					НоваяСтрока.НомерВерсииРазряд1 = Число(СтрПолучитьСтроку(МногоСтрока, 1));
					НоваяСтрока.НомерВерсииРазряд2 = Число(СтрПолучитьСтроку(МногоСтрока, 2));
					НоваяСтрока.НомерВерсииРазряд3 = Число(СтрПолучитьСтроку(МногоСтрока, 3));
					НоваяСтрока.НомерВерсииРазряд4 = Число(СтрПолучитьСтроку(МногоСтрока, 4));
					НоваяСтрока.ИмяМетода = ЧтениеСтрокиXML.Значение;
				КонецЕсли;
			КонецЦикла;
		КонецЕсли;
	КонецЦикла;
	ТаблицаОбновлений.Сортировать("НомерВерсииРазряд1, НомерВерсииРазряд2, НомерВерсииРазряд3, НомерВерсииРазряд4");
	
	ТекущаяВерсияИБ = Константы.НомерВерсииКонфигурации.Получить();
	МногоСтрока = СтрЗаменить(ТекущаяВерсияИБ, СимволРазделитель, Символы.ПС);
	НомерВерсииРазряд1 = Число(СтрПолучитьСтроку(МногоСтрока, 1));
	НомерВерсииРазряд2 = Число(СтрПолучитьСтроку(МногоСтрока, 2));
	НомерВерсииРазряд3 = Число(СтрПолучитьСтроку(МногоСтрока, 3));
	НомерВерсииРазряд4 = Число(СтрПолучитьСтроку(МногоСтрока, 4));
	
	ЧисловоеПредставлениеТекВерсии =  НомерВерсииРазряд1 *Pow(10, 9) + НомерВерсииРазряд2 *Pow(10, 6) + НомерВерсииРазряд3 *Pow(10, 3) +  НомерВерсииРазряд4;
	
	Для Каждого ТекСтрока Из ТаблицаОбновлений Цикл
		
		ЧисловоеПредставление =  ТекСтрока.НомерВерсииРазряд1 *Pow(10, 9) + 
								 ТекСтрока.НомерВерсииРазряд2 *Pow(10, 6) + 
								 ТекСтрока.НомерВерсииРазряд3 *Pow(10, 3) +  
								 ТекСтрока.НомерВерсииРазряд4;

		Если  ЧисловоеПредставлениеТекВерсии < ЧисловоеПредставление Тогда 
			Выполнить("Обработки._ОбработкаОбновления.Создать()." + ТекСтрока.ИмяМетода + "()");
			НоваяВерсияИБ = ТекСтрока.НомерВерсии;
			Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
			
			лЗапись = РегистрыСведений.ВерсииПодсистем.СоздатьМенеджерЗаписи();
			лЗапись.ИмяПодсистемы = Метаданные.Имя;
			лЗапись.Версия = НоваяВерсияИБ;
			лЗапись.Записать(Истина);
		 КонецЕсли;
		//СтрокаТекущейВерсии = ТаблицаОбновлений.Найти(ТекущаяВерсияИБ, "НомерВерсии");
		//Если СтрокаТекущейВерсии = Неопределено Тогда
		//	Продолжить;
		//КонецЕсли;
		//ИндексТекущейВерсии = ТаблицаОбновлений.Индекс(СтрокаТекущейВерсии);
		
		//НоваяВерсияИБ = ТекСтрока.НомерВерсии;
		//ИндексНовойВерсии = ТаблицаОбновлений.Индекс(ТекСтрока);
		//Если (ИндексТекущейВерсии < ИндексНовойВерсии) тогда
		//	Выполнить("Обработки._ОбработкаОбновления.Создать()." + ТекСтрока.ИмяМетода + "()");
		//	Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
		//	
		//	лЗапись = РегистрыСведений.ВерсииПодсистем.СоздатьМенеджерЗаписи();
	...
	//18.02.2019 Валиахметов XX-1980 Не меняется релиз (рс Версии подсистем) при обновлении релиза конф
	лЗапись = РегистрыСведений.ВерсииПодсистем.СоздатьМенеджерЗаписи();
	лЗапись.ИмяПодсистемы = Метаданные.Имя;
	лЗапись.Версия = Метаданные.Версия;
	лЗапись.Записать(Истина);
	//Конец 18.02.2019 Валиахметов XX-1980 Не меняется релиз (рс Версии подсистем) при обновлении релиза конф
	
	//ХудинВВ 11042019 XX-2294
	Справочники.АлгоритмыПроцессов.ВыключитьАлгоритмыПоНомеруРелиза(Метаданные.Версия);
...
Функция ПодготовитьМакетОписаниеОбновлений(ФормаОписаниеОбновлений) Экспорт
	...
	//Параметры.ФормаСпискаНоменклатуры          = Справочники.Номенклатура.ПолучитьФормуСписка();  ado_return
	//Параметры.ФормаСпискаТиповЦенНоменклатуры  = Справочники.ТипыЦенНоменклатуры.ПолучитьФормуСписка();  ado_return
	//Параметры.ФормаСпискаТиповСкидокНаценок    = Справочники.ТипыСкидокНаценок.ПолучитьФормуСписка();  ado_return
	...
	//Параметры.ФормаАнализСостоянияВзаиморасчетовПослеПереходаНаРедакцию10_3		= Отчеты.АнализСостоянияВзаиморасчетовПослеПереходаНаРедакцию10_3.ПолучитьФорму("Форма");  ado_return
...
Процедура ЗаполнитьСправочникВидыКонтактнойИнформации()
	...
	Состояние("Обновление справочника ""Виды контакткной информации""");
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.Ссылка = Справочники.ВидыКонтактнойИнформации.АдресДоставкиКонтрагента Тогда
			...
			УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.Адрес);
		...
		//	
		//	УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты, Перечисления.ВидыОбъектовКонтактнойИнформации.ТорговыеТочки);
		//				
		...
		//	
		//	УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.Телефон, Перечисления.ВидыОбъектовКонтактнойИнформации.ТорговыеТочки);
		//				
		...
		//ИначеЕсли Выборка.ссылка = Справочники.ВидыКонтактнойИнформации.ФактАдресФилиала Тогда				
		//	
		//	УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.Адрес, Перечисления.ВидыОбъектовКонтактнойИнформации.Филиалы);
		//ИначеЕсли Выборка.ссылка = Справочники.ВидыКонтактнойИнформации.ТелефонФилиала Тогда				
		//	
		//	УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.Телефон, Перечисления.ВидыОбъектовКонтактнойИнформации.Филиалы);
		//ИначеЕсли Выборка.ссылка = Справочники.ВидыКонтактнойИнформации.ФактАдресТорговойТочки Тогда				
		//	
		//	УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.Адрес, Перечисления.ВидыОбъектовКонтактнойИнформации.ТорговыеТочки);
		//ИначеЕсли Выборка.ссылка = Справочники.ВидыКонтактнойИнформации.ТелефонТорговойТочки Тогда				
		//	
		//	УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.Телефон, Перечисления.ВидыОбъектовКонтактнойИнформации.ТорговыеТочки);
		//ИначеЕсли Выборка.ссылка = Справочники.ВидыКонтактнойИнформации.АдресЭлектроннойПочтыДополнительный Тогда				
		//	
		//	УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.Телефон, Перечисления.ВидыОбъектовКонтактнойИнформации.ТорговыеТочки);
		//ИначеЕсли Выборка.ссылка = Справочники.ВидыКонтактнойИнформации.ФактАдресИзготовителя Тогда				
		//	
		//	УстановитьпараметрыВидаКонтаткнойИнформации(Выборка.Ссылка, Перечисления.ТипыКонтактнойИнформации.Адрес, Перечисления.ВидыОбъектовКонтактнойИнформации.Изготовители);
		КонецЕсли; 
...
Процедура ЗаполнитьКонтактныеЛица()
	...
	//Шапки документов  ЗаявкаПокупателя, ЗаказПоставщику, СчетНаОплатуПокупателю, СчетНаОплатуПоставщика
	Запрос = Новый Запрос;
	...
	|		ЗаявкаПокупателя.УдалитьКонтактноеЛицо КАК УдалитьКонтактноеЛицо,
...
Процедура ЗаполнитьЗадачиНапоминаниями()
	...
	|	ЗаявкаПокупателя.УдалитьВремяНапоминания
	|ИЗ
	|	Документ.ЗаявкаПокупателя КАК ЗаявкаПокупателя
	|ГДЕ
	|	ЗаявкаПокупателя.УдалитьНапомнитьОСобытии = ИСТИНА
	|	И ЗаявкаПокупателя.Ответственный <> ЗНАЧЕНИЕ(Справочник.Пользователи.ПустаяСсылка)
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ
...
Процедура УстановитьЗаказВТоварыПереданные()
	...
	|	И Док.ЗаявкаПокупателя <> ЗНАЧЕНИЕ(Документ.ЗаявкаПокупателя.ПустаяСсылка)
	|	И Док.Ссылка.Проведен
	|	И Док.ЗаявкаПокупателя <> Док.Ссылка.Сделка
	|");
	...
	Пока Выборка.Следующий() Цикл
		...
		Если СтруктураШапкиДокумента.ВидДоговора = Перечисления.ВидыДоговоровКонтрагентов.СКомиссионером Тогда
			...
			КопияТовары.Колонки.ЗаявкаПокупателя.Имя = "Сделка";
