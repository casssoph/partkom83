...
Процедура ПрочитатьФайлXLS(СтруктураФайла)
	...
	ВыполнятьЗаменуИзготовителя = Неопределено;
	Если НЕ СтруктураФайла.Свойство("ВыполнятьЗаменуИзготовителя", ВыполнятьЗаменуИзготовителя) Тогда
		ВыполнятьЗаменуИзготовителя = Ложь;
	КонецЕсли;
	...
	Если ВыполнятьЗаменуИзготовителя Тогда
		ТаблицаЗаменИзготовителя = Справочники.Изготовители.ТаблицаЗамен();
	КонецЕсли;
			...
			Попытка
				...
				Иначе
					...
					ИначеЕсли ИмяКолонки="Изготовитель" Или ИмяКолонки="ИзготовительПоставщика" Тогда
						ИзготовительФайла = ЭлектронныеДокументы.НормализоватьСтрокуИзготовителя(ТекущееЗначение);
						НоваяСтрока[ИмяКолонки] = ?(ВыполнятьЗаменуИзготовителя, ПолучитьЗаменуИзготовителя(ИзготовительФайла, ТаблицаЗаменИзготовителя), ИзготовительФайла);
					Иначе 	
						НоваяСтрока[ИмяКолонки] = ТекущееЗначение;
					КонецЕсли;	
				КонецЕсли;
...
//Прочее
Функция ПолучитьЗаменуИзготовителя(Изготовитель, ТаблицаЗаменИзготовителя)
	
	Замена = Изготовитель;
	
	НайденнаяСтрока = ТаблицаЗаменИзготовителя.Найти(Изготовитель, "Изготовитель");
	Если НЕ НайденнаяСтрока = Неопределено Тогда
	   Замена = НайденнаяСтрока.Замена;
	КонецЕсли;
