...
Функция СоздатьДокументыРТУНаДату(ДатаСоздания, ТекстОшибки = "")
	...
	|	ВЫРАЗИТЬ(ПартииТоваровОбороты.Регистратор КАК Документ.РеализацияТоваровУслуг).Организация КАК ОрганизацияПокупатель,
	...
	|	И НЕ ВЫРАЗИТЬ(ПартииТоваровОбороты.Регистратор КАК Документ.РеализацияТоваровУслуг).Организация = ПартииТоваровОбороты.Организация
	...
	Пока ВыборкаОрганизацияПродавец.Следующий() Цикл
		...
		Пока ВыборкаОрганизацияПокупатель.Следующий() Цикл
			...
			ВыборкаТовары = ВыборкаОрганизацияПокупатель.Выбрать();
			
			ДокументОбъект = НайтиСоздатьДокументМФП(ВыборкаОрганизацияПокупатель.ОрганизацияПродавец, ВыборкаОрганизацияПокупатель.ОрганизацияПокупатель, ДатаСоздания);
			ЗаполнитьШапкуДокументаМФП(ДокументОбъект, ВыборкаОрганизацияПокупатель.ОрганизацияПродавец, ВыборкаОрганизацияПокупатель.ОрганизацияПокупатель, ПравилаСозданияМФП, ДатаСоздания);
...
Функция  НайтиСоздатьДокументМФП(ОрганизацияПродавец, ОрганизацияПокупатель, ДатаДокумента)
...
Процедура  ЗаполнитьШапкуДокументаМФП(ДокументОбъект, ОрганизацияПродавец, ОрганизацияПокупатель, ПравилаСозданияМФП, ДатаДокумента)
...
Функция ЗаполнитьРегистрВозвратыМФП(ДатаСоздания, ТекстОшибки = "") Экспорт
	...
	|			И (ОрганизацииПолитик.ОрганизацияПокупательСписаниеПартий = ВозвратыМФП.ОрганизацияПокупательСписаниеПартий)
	|ГДЕ
	|	ОрганизацииПолитик.Политика ЕСТЬ NULL";
