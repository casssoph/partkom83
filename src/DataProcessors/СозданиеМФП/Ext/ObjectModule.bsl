	...
	Пока ВыборкаОрганизацияПродавец.Следующий() Цикл
		...
		Пока ВыборкаОрганизацияПокупатель.Следующий() Цикл
			...
			Пока ВыборкаУчитыватьНДС.Следующий() Цикл
				...
				ДокументОбъект_ПТУ = НайтиСоздатьДокументПТУМФП(ВыборкаОрганизацияПокупатель.ОрганизацияПродавец, ВыборкаОрганизацияПокупатель.ОрганизацияПокупатель, ДатаСоздания, ВыборкаУчитыватьНДС.УчитыватьНДС);
				ЗаполнитьШапкуДокументаПТУМФП(ДокументОбъект_ПТУ, ВыборкаОрганизацияПокупатель.ОрганизацияПродавец, ВыборкаОрганизацияПокупатель.ОрганизацияПокупатель, ПравилаСозданияМФП, ДатаСоздания, ВыборкаУчитыватьНДС.УчитыватьНДС);
...
Функция  НайтиСоздатьДокументПТУМФП(ОрганизацияПродавец, ОрганизацияПокупатель, ДатаДокумента, УчитыватьНДС)
	...
	Запрос.УстановитьПараметр("ВидОперации", Перечисления.ВидыПоступленияТоваров.МФП);
	Запрос.УстановитьПараметр("Дата", ДатаДокумента);
...
Процедура  ЗаполнитьШапкуДокументаПТУМФП(ДокументОбъект, ОрганизацияПродавец, ОрганизацияПокупатель, ПравилаСозданияМФП, ДатаДокумента, УчитыватьНДС)
	...
	ДокументОбъект.Дата 				= ДатаДокумента;
	ДокументОбъект.ВидОперацииПоступления = Перечисления.ВидыПоступленияТоваров.МФП;
