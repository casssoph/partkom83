...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	ИначеЕсли ВРег(ИсточникВыбора.ВладелецФормы.ИмяФормы) = ВРег("Справочник.КлючевыеОперации.Форма.ФормаВыбора") 
		...
		Если ТипЗнч(ВыбранноеЗначение) = Тип("СправочникСсылка.КлючевыеОперации") тогда
