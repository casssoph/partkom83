...
|////////////////////////////////////////////////////////////////////////////////
		...
		|		ИНАЧЕ
		|	         ВЫБОР 
		|	         	КОГДА ДоговораПоставщиковКрос.ДоговорКонтрагента.ВидДоговора = КА.ОсновнойДоговорКонтрагентаЗакупка.ВидДоговора И ДоговораПоставщиковКрос.ДоговорКонтрагента.ДоговорНаКросс = КА.ОсновнойДоговорКонтрагентаЗакупка.ДоговорНаКросс ТОГДА КА.ОсновнойДоговорКонтрагентаЗакупка
...
|////////////////////////////////////////////////////////////////////////////////
		...
		|			(СтрокаЗаявки.СостояниеЗаказа ЕСТЬ NULL
		|				ИЛИ СтрокаЗаявки.СостояниеЗаказа = ЗНАЧЕНИЕ(Справочник.СтатусыДокументов.ПустаяСсылка))
