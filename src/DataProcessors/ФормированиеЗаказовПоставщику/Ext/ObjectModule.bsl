					...
					Попытка
						...
						Для каждого СтрРассылки из АктуальныеЗаданияБезПотребностиДляРассылки цикл
							...
							Если СтрРассылки.Задание_ПополнениеСкладаОтдельно тогда
								СтрРассылки_Задание_ТекстПисьма = СтрРассылки_Задание_ТекстПисьма + " потребность в заказах ( для пополнения склада ) отсутствует"+ Символы.ПС + Символы.ПС + "С уважением,"+ Символы.ПС + "отдел снабжения компании ""ПартКом"". Телефон (831) 421-50-41.";
							Иначе
								СтрРассылки_Задание_ТекстПисьма = СтрРассылки_Задание_ТекстПисьма + " потребность в заказах ( для клиентов ) отсутствует"+ Символы.ПС +  Символы.ПС + "С уважением,"+ Символы.ПС +  "отдел снабжения компании ""ПартКом"". Телефон (831) 421-50-41.";
							КонецЕсли;
